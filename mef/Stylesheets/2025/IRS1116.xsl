...
<!-- Last Modified by Jermaine Merchant 5/6/2025 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="CreatePartITableTemplate">
      ...
      Enter the name of the foreign country or U.S.
			...
			(Add cols. <xsl:value-of select="$ColALetter"/>, <xsl:value-of select="$ColBLetter"/>, and <xsl:value-of select="$ColCLetter"/>.)
      <!--(Add cols. A, B, and C.)-->
    </td>			
		</tr>
		<tr>
			...
			<body class="styBodyClass">
          	    ...
          	    Resident of (name of country)                
					...
					<div class="styBB" style="width: 187mm; height: 7.5mm; padding-top: 0.5mm; border-bottom-width: 0px;">
						<div class="styBB" style="width: 187mm; height: 7mm; clear: none;">
							<b>Note: </b> If you paid taxes to only one foreign country or U.S. territory, use column A in Part I and line A in Part II. If you paid taxes to <b>more than one</b> 
							foreign country or U.S. territory, use a separate column and line for each country or territory.
						</div>
					</div>
					<!-- End Top Section -->
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
              ...
              Foreign Taxes Paid or Accrued <span class="styNormalText">(see instructions)</span>
					...
					<div class="pageEnd" style="width:187mm;border-top:0.4mm solid black;clear:all;">
                        ...
                        <div class="stySmallText" style="width:36mm;text-align:right;">Form <span class="styBoldText">1116</span> (2025)
                   </div>
					</div>
					<!--End Footer-->
					...
					<div class="styStdDiv">
						<div style="float:left;">Form 1116 (2025)<span style="width:148mm;"/>
						</div>
					...
					<div class="styBB" style="width: 187mm; height: auto;">
						...
						<!-- (17) ////////////////////////////////////////////////////-->
						<div class="styIRS1116LineItem" style="width: 187mm; height: 8mm;">
							<div class="styIRS1116LNLeftNumBox" style="padding: 1mm 0.5mm 0.5mm 1mm; width: 5mm; height: 8mm; text-align: left;">17</div>
							<div class="styIRS1116LNDesc" style="padding: 1mm 3mm; width: 114mm; height: 8mm;">
								<span style="vertical-align: middle; display: inline-block;">
					   Combine the amounts on lines 15 and 16. This is your net foreign source taxable income. 
					   (If the result is zero or less, skip line 18 and enter zero on line 19.)
						<span style="width:.5mm"/>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;padding-top:.3mm;">..</span>
								</span>
					...
					<!--<span style="width:.3mm"/>                                  -->
							...
							<xsl:call-template name="CreateBoxLine7">
								...
								<xsl:with-param name="AmountBoxStyle">padding: 6.5mm 0.5mm 0mm 0mm; width: 26mm; height: 10mm; text-align: right; font-size: 6.5pt; border-right-width: 0px;</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">padding: 6.5mm 0mm 0mm; height: 10mm; border-right-width: 0px;</xsl:with-param>
...
Form 8978, Partner’s Additional Reporting Year Tax, see instructions.
							...
							<div class="styLNRightNumBox" style="padding: 0px; width:8mm; height: 10mm; border-bottom-width: 0px; border-left-width: 1px;"/>
						...
						<!-- (24) ////////////////////////////////////////////////////-->
						<div class="styIRS1116LineItem" style="width: 187mm; height: 5mm;">
							<div class="styIRS1116LNLeftNumBox" style="padding: 2mm 0.5mm 0.5mm 1mm; width: 5mm; height: 5mm; text-align: left;">24</div>
							<div class="styIRS1116LNDesc" style="padding: 1.5mm 3mm; width: 148mm; height: 5mm;">
								<span style="vertical-align: middle; display: inline-block;">                  
						Enter the <b>smaller</b> of line 14 or line 23. Enter here and on the appropriate line in Part IV. See instructions
						<xsl:if test="$Form1116Data/GrossForeignTaxCreditAmt/@foreignIncomeLumpSumDistribCd">
							...
							<xsl:call-template name="CreateBoxLine7">
								...
								<xsl:with-param name="AmountBoxStyle">padding: 2mm 0.5mm 0mm 0mm; width: 26mm; height: 5mm; text-align: right; font-size: 6.5pt; border-right-width: 0px;
					  border-bottom-width: 0px;</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">padding: 2mm 0mm 0mm; height: 5mm; border-right-width: 0px; border-bottom-width: 0px;</xsl:with-param>
					...
					<div class="pageEnd" style="width:187mm; border-top:0.5mm solid black;">
						<div style="float:right;">
							<span style="width:80px;"/>  
                             Form <span class="styBoldText">1116</span> (2025)
                    </div>
					</div>
