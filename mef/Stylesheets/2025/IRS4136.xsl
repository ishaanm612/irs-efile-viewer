				...
				<form name="IRS4136">
					...
					<div class="styBB" style="width:187mm;height:21mm;border-bottom-width:2px;">
						...
						<div class="styGenericDiv" style="width:128mm;height:21mm;text-align:center;font-weight:bold;">
							...
							<div class="styFBT" style="height:4mm;padding-top:3mm;">
							...
							<div class="styFBT" style="padding-top:1mm;">Complete and attach the Worksheet Fuel Tax Credit-1 to your return (see instructions)
							</div>
						</div>
					...
					<div class="styIRS4136CautionHdr" style="padding-left:1.5mm;border-top-width:2px;">
						<span class="styIRS4136CautionHdrTitle" style="padding-left:2mm;padding-right:1mm;">Caution: </span><br/>
						<span style="font-style: normal;width:186mm;float:left;font-size:7.75pt;padding-left:7mm;padding-right:1mm;padding-bottom:1mm;">
        The person(s) signing the return with which this form is filed are declaring, under penalty of perjury, that the return and accompanying schedules, statements, and any other attachments are true, correct, and complete to the best of the signer’s knowledge and belief. That declaration includes all amounts reported and all credits claimed on this form. It also includes certifying that all the statements with respect to certain lines below as well. <br/>
...
For type of use 2, the equipment or vehicle used wasn't a highway vehicle, which generally means that it wasn't registered or required to be registered for use on public highways.
						</span>
					</div>
					<!--   END  NOTE  HEADER   -->
					<!-- ============================================================================= -->
                ...
                Other nontaxable use (see <b>Caution </b>above line 1)   
					...
					<div class="styIRS4136DescLine"><b>You certify the following.</b> The diesel fuel did not contain visible evidence of dye.<br/>
					...
					<div class="styIRS4136DescLine"><b>You certify the following.</b> The kerosene did not contain visible evidence of dye.<br/>
					...
					<div style="width:187mm;">
						...
						<div style="float:right">Cat. No. 12625R
							<span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2024)
						</div>
					</div>
					<!-- ============================================================================= -->
					<!--  PAGE 2 HEADER -->
					...
					<p style="page-break-before: always">
						<div class="styBB" style="width:187mm;border-bottom:2px solid black;">
							<div style="float: left; clear: none">Form 4136 (2024)</div>
					...
					<div class="styIRS4136NumLine">
						6<span style="width:6mm"/>Sales by Registered Ultimate Vendors of Undyed Diesel Fuel
							<span style="float:right;width:70mm;">
								...
								<br/>
						<span style="margin-left: 8mm;"/>If you don't have the registration number, STOP; you're not eligible to make Form 4136 claims <br/>
						<span style="margin-left: 8mm;"/>if you haven't yet filed Form 637 and received your registration number and placed it on this line.
					</div>
					<div class="styIRS4136DescLine" style="border-bottom:0;"><b>You certify the following.</b> You sold the diesel fuel at a tax-excluded price, repaid the amount of tax
					 to the buyer, or have obtained the written consent of the buyer to make the claim, and that the diesel fuel didn't
...
-->
					...
					<div class="styIRS4136DescLine"><b>You certify the following.</b> You sold the kerosene at a tax-excluded price,
					 repaid the amount of tax to the buyer, or have obtained the written consent of the buyer to make the claim, and that
					 the kerosene didn't contain visible evidence of dye. <br/>
				...
				<!--<div class="styIRS4136NumLine" style="height:20mm;border-bottom:0;"/>-->
					...
					<div class="styIRS4136NumLine">
						...
						<span style="float:right;width:70mm;">Registration No.
						<!--<img src="{$ImagePath}/4136_Bullet.gif" alt="Right pointing arrowhead"/>-->
							<span style="width:4px;"/>
							<span style="font-weight:normal">
								<xsl:call-template name="PopulateText">
					...
					<b>You certify the following.</b> You sold the kerosene for use in aviation at a tax-excluded price and you haven't collected the amount of tax from the buyer,
					repaid the amount of tax to the buyer, or you've obtained the written consent of the buyer to make the claim. See the instructions
					...
					<div style="width:187mm;">
						...
						<div style="float:right">
							<span style="width:70px"/>Form <span class="styBoldText" style="font-size: 8pt">4136</span> (2024)</div>
					</div>
					<!-- ============================================================================= -->
					<!--  PAGE 3 HEADER -->
					<!-- ============================================================================= -->
					...
					<div class="styIRS4136NumLine" style="padding-left:1mm;">
						...
						<br/>
						<span style="width:9mm"/>If you haven't attached the appropriate certificates and, if applicable, appropriate reseller statements,<br/>
						<span style="width:9mm;"/>STOP; you're not eligible to make Form 4136 claims.
					</div>
					<div class="styBB" style="width:177mm;margin-left:10mm;padding-bottom:1mm;"><b>You certify the following.</b><br/>
					<b>Biodiesel or renewable diesel mixtures.   </b>  You produced a mixture by mixing biodiesel with diesel fuel or renewable diesel with liquid fuel
...
<b>Sustainable aviation fuel (SAF) mixtures.</b> You produced a qualified mixture by mixing SAF with kerosene. The qualified mixture was
produced by you in the United States, such mixture was used by you (or sold by you for use) in an aircraft, such sale
or use was in the ordinary course of your trade or business, and the transfer of such mixture to the fuel tank of such aircraft
...
coprocessing an applicable material (or materials derived from an applicable material) with a feedstock that is not biomass, (iii) isn't derived
...
emissions reduction percentage of at least 50 percent. <b>For all claims.</b> You've attached the appropriate certificates and, if applicable,
appropriate reseller statements. You have no reason to believe that the information in the certificate or statement is false. See the
instructions for additional information and requirements.
					...
					<div class="styNumLine" style="padding-left:1mm;font-size:8pt;width:187mm;font-weight:bold;border-bottom:1px solid black;padding-top:6mm;padding-bottom:2mm;">
						...
						<br/>
						<span style="width:9mm"/>If you don't have the registration number, STOP; you're not eligible to make Form 4136 claims<br/> 
						<span style="width:9mm;"/>if you haven't yet filed Form 637 and received your registration number and placed it on this line.						
					</div>
...
<!--								<img src="{$ImagePath}/4136_Bullet.gif" alt="Right pointing arrowhead"/>-->
					...
					<div class="pageEnd" style="width:187mm;padding-top:.5mm;">
						<div style="float:right">
							<span style="width:80px"/>Form <span class="styBoldText">4136</span> (2024)</div>
					</div>
					<!-- ============================================================================= -->
					<!--  LEFTOVER DATA -->
					<!-- ============================================================================= -->
