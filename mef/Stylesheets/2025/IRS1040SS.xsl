...
-->
	...
	*************************************************************************************************************************************************************** 
	...
	<xsl:template name="PopulateYesNoGroup_PR">
		...
		<span class="styBoldText">Si</span></span>
		<span style="width: 2mm;"/>
		<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
		<span>
			<xsl:call-template name="PopulateSpan">
			...
			<body class="styBodyClass" style="width:187mm;">
				<form name="IRS1040SSPR" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;">
                      ...
                      Mariana Islands, or Puerto Rico. For the year Jan. 1-Dec. 31, 2025,<br/>
                    ...
                    Foreign postal code
							...
							<div class="styIRS1040SSPRCleanDiv" style="width:100%;height:16%;">
								<div class="styIRS1040SSPRCleanDiv" style="width:187mm;height:100%;">
									<div class="styIRS1040SSPRLNDesc" style="width:100%;height:auto;font-size:7pt;padding:.5mm 0mm 0mm 1mm;">
At any time during 2025, did you: (a) receive (as a reward, award, or payment for property or services); or (b) sell, exchange, or otherwise dispose of a digital<br/> asset (or a financial interest in a digital asset)? (See instructions) 
<span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">..................</span>
                ...
                <span class="styDotLn" style="float:none;clear:none;padding-left:1mm;">...................</span>
                 <input type="checkbox" alt="MoreDependents" class="styCkbox" style="margin:.5mm 0mm;">
					...
					<div class="styBB" style="width:187mm; font-size:8pt">
						...
						<xsl:with-param name="Description"><b>Total tax.</b> Add lines 3 through 6.</xsl:with-param>
						<xsl:with-param name="Dots">.........................</xsl:with-param>
						...
						<xsl:with-param name="Description">2025 estimated tax payments</xsl:with-param>
						<xsl:with-param name="Dots">................</xsl:with-param>
						...
						<xsl:with-param name="Description">Excess social security tax withheld </xsl:with-param>
						<xsl:with-param name="Dots">.............
								<xsl:call-template name="SetFormLinkInline">
                ...
                Account Number
						...
						<xsl:with-param name="Description"><b>Amount you owe.</b> If line 7 is more than line 12, subtract line 12 from line 7</xsl:with-param>
						<xsl:with-param name="Dots">...........</xsl:with-param>
			...
			<body class="styBodyClass" style="width:187mm;">
					...
					<div class="styBB" style="width:187mm;height:55mm;">
						...
						<div class="styIRS1040PRCleanDiv" style="width:100%;height:100%;">
							...
							<div class="styIRS1040SSPRCleanDiv" style="width:100%;height:16%;">
								<div class="styIRS1040SSPRCleanDiv" style="width:187mm;height:100%;">
									<div class="styIRS1040SSPRLNDesc" style="width:100%;height:auto;font-size:7pt;padding:.5mm 0mm 0mm 1mm;">
								En algún momento durante 2025, ¿(a) recibió (como recompensa, premio o pago por bienes o servicios) o (b) vendió, intercambió o de otra manera<br/> enajenó un activo digital (o un interés financiero en un activo digital)? (Vea las instrucciones) 
				...
				Si marcó el recuadro de casado que presenta una declaración por separado, anote arriba el número de Seguro Social de su cónyuge y el nombre completo aquí: 
					...
					<div class="styBB" style="width:187mm; font-size:8pt">
						...
						<xsl:call-template name="PopulateLeftShiftedLine">
						<xsl:with-param name="Number">8</xsl:with-param>
						<xsl:with-param name="Description">Pagos del impuesto estimado del año 2025
						...
						<xsl:with-param name="Number">15</xsl:with-param>
						<xsl:with-param name="Rows">2</xsl:with-param>
						<xsl:with-param name="Description">	Cantidad de la línea <b>13</b> que quiere que se le <b>aplique al impuesto<br/>
										estimado de 2026</b></xsl:with-param>
						<xsl:with-param name="Dots">....................</xsl:with-param>
						<xsl:with-param name="TargetNode" select="$Form1040SSData/AppliedToEsTaxAmt"/>
						</xsl:call-template>
						<!-- I Line 16 -->
						...
						<xsl:with-param name="Number">16</xsl:with-param>
						<xsl:with-param name="Rows">2</xsl:with-param>
						<xsl:with-param name="Description">	<b>Cantidad que usted adeuda.</b> Si la  línea <b>7</b> es mayor que la  línea <b>12</b>, reste la<br/>
										 línea <b>12</b> de la  línea <b>7</b>. </xsl:with-param>
						<xsl:with-param name="Dots">............................</xsl:with-param>
						<xsl:with-param name="TargetNode" select="$Form1040SSData/OwedAmt"/>
						</xsl:call-template>
