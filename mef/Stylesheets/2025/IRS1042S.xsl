									...
									<table style="float-left;" cellpadding="0" cellspacing="0">
										...
										<span style="float:left;padding-left:4mm;">1042-S to report to a Specific recipient</span>	
											<span class="styBoldText" style="float:right;padding-right:2mm;">
													...
													<div style="float-right;width:5mm;">
														<span style="padding-top:1mm;">
															<input alt="Check if you are a Qualified Intermediary, Withholding Foreign Partnership, or Withholding Foreign Trust revising its reporting on Form 1042-S to report a specific recipient." type="checkbox" class="styCkbox" name="QIOrWPOrWTRevisingReportingInd">
																<xsl:call-template name="PopulateCheckbox">
