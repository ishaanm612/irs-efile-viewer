...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
			...
			<body class="styBodyClass" style="width:187mm;">
				...
				<div class="styStdDiv">
					...
					<div class="sty709NALongDesc">
						...
						<span class="sty709NADotLn" style="margin-right:8mm;">.................<input type="checkbox" class="styCkboxNM" aria-label="Time To File Extension">
								<xsl:call-template name="PopulateCheckbox">
				...
				<div class="styStdDiv" style="border-top:1px solid black;">
					...
					<div class="styLNRightNumBoxNBB" style="height:8mm;background-color:lightgrey;border-left-width:0px;">&nbsp;</div>
				</div>
				<!-- Line 23b -->
				<div class="styStdDiv">
					<div class="styLNLeftNumBox" style="padding-left:4.4mm;">b</div>
					...
					<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:4.5mm;border-left-width:0px;">&nbsp;</div>
				</div>
              ...
              <div style="width:164mm;float:left;clear:none;">
				...
				<div class="styStdIBDivLS">
					...
					<div class="styLNDesc" style="width:206.8mm;height:auto;">
						Total amount of taxable gifts for prior periods. Add amount on line 1, column (e), and amount, if any, on line 2. Enter here and on Part 2&mdash;Tax <br /> Computation, line 2
						<span class="sty709NADotLn">............................................</span>
					</div>
				...
				<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
					<div class="styLNDesc" style="width:100%;font-weight:bold;">
						Part 2 &mdash; GST Exemption Reconciliation (Section 2631) and Section 2652(a)(3) Election
					</div>
				</div>
				<div class="styStdDivLS">
	...
	<xsl:template name="FillPage4Table">
		...
		<tr style="font-size:7pt;vertical-align:bottom;min-height:7mm;">
			...
			<td class="styTableCellCtrInherit">
				<input type="checkbox" class="styCkboxNM" style="">
					<xsl:attribute name="aria-label">Item <xsl:value-of select="$LineNumber"/> Sectioni 2632 b Election out</xsl:attribute>
					<xsl:call-template name="PopulateCheckbox">
						<xsl:with-param name="TargetNode" select="/.."/>
	...
	<xsl:template name="FillPage5Table">
		...
		<tr style="font-size:7pt;vertical-align:bottom;min-height:7mm;">
			...
			<td class="styTableCellCtrInherit">
				<input type="checkbox" class="styCkboxNM" style="">
					<xsl:attribute name="aria-label">Item <xsl:value-of select="$LineNumber"/> Sectioni 2632 c Election out</xsl:attribute>
					<xsl:call-template name="PopulateCheckbox">
						<xsl:with-param name="TargetNode" select="/.."/>
