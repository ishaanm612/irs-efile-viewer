  ...
  <body class="styBodyClass">
    ...
    <!--xsl:value-of select='$PageWatermark'/-->
      ...
      <table class="border-none" style="width:256mm">
        ...
        <tbody>
			<xsl:choose>
				<!-- For Empty Schema Table 1 -->
				<xsl:when test= "not($Form4255Data/Form7207PYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						 font-weight: 700;">1a</td>
						<td style="border-left: none">Form 7207</td>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form3468PartIIIPYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form7210PYCreditsGrp) ">
					<tr>
					  <td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form3468PartIVPYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
				...
				<!-- For Full Schema -->
					<xsl:for-each select="$Form4255Data/Form3468PartIVPYCreditsGrp">
						<tr>							
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/Form3468PartIVPYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/Form3468PartVIPYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form7218PYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form7213PartIIPYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form3468PartVPYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						...
						<tr>
						  <td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						   font-weight: 700;">g</td>
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/Form3468PartVPYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/Form3468PartVPYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form8936PartVPYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						...
						<tr>
						  <td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						   font-weight: 700;">h</td>
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/Form8936PartVPYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/Form8936PartVPYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form7211PYCreditsGrp)">
					<tr>
					  <td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form3468PartVIPYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
				...
				<!-- For Full Schema -->
					<xsl:for-each select="$Form4255Data/Form3468PartVIPYCreditsGrp">
						<tr>
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/Form3468PartVIPYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form8835PYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/OtherNonChapter1PYCreditsGrp)">
					<tr>
						<td style="border-top: none; text-align: right; vertical-align:top; padding-right:6px;
						 font-weight: 700">z</td>
						<td style="border-left: none">Other line 1 tax</td>
						<td class="styTableCellTextInherit">
						</td>
						<td class="grayed-out"></td>
						<td class="grayed-out"></td>
				...
				<!-- For Full Schema -->
					<xsl:for-each select="$Form4255Data/OtherNonChapter1PYCreditsGrp">
						<tr>
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/OtherNonChapter1PYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/OtherNonChapter1PYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form8933PYCreditsGrp)">
					<tr>
					  <td style="width:3.5mm; text-align:right;padding-right:6px; border-right: none; 
					   border-bottom: none;border-top:none;font-weight: 700;">2a</td>
				...
				<!-- For Full Schema -->
					<xsl:for-each select="$Form4255Data/Form8933PYCreditsGrp">
						<tr>
						  <td style="width:3mm; text-align:right; padding-right:6px; border-right: none; 
						   border-bottom: none;border-top:none;font-weight: 700;">2a</td>
							<td style="width:12.5mm; border-left: none">Form 8933</td>
							<td class="styTableCellTextInherit">
								<xsl:call-template name="PopulateAmount">
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/Form8933PYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/Form8933PYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/Form8911PartIPYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						 font-weight: 700;">b</td>
						<td style="border-left: none">Form 8911, <br/>Part I</td>
						<td class="styTableCellTextInherit">
						</td>
						<td class="styTableCellTextInherit">
						</td>
				...
				<!-- For Full Schema -->
					<xsl:for-each select="$Form4255Data/Form8911PartIPYCreditsGrp">
					  <tr>
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/Form8911PartIPYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/Form8911PartIPYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/OtherChapter1PYCreditsGrp)">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						 font-weight: 700;">z</td>
						<td style="border-left: none">Other line 2 tax</td>
						<td class="styTableCellTextInherit">
						</td>
						<td class="grayed-out"></td>
						<td class="grayed-out"></td>
				...
				<!-- For Full Schema -->
					<xsl:for-each select="$Form4255Data/OtherChapter1PYCreditsGrp">
						<tr>
							...
							<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/OtherChapter1PYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/OtherChapter1PYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
			...
			<xsl:choose>
				<!-- For Empty Schema -->
				<xsl:when test="not($Form4255Data/TotalAmountsPYCreditsGrp)">
					<tr style="border-top: solid 2px;">
						<td style="border: none; text-align: right; vertical-align:top; padding-right:12px;
						 font-weight: 700;">3</td>
						...
						<td style="border: none; text-align: right; vertical-align:top; padding-right:12px;
						 font-weight: 700;">3</td>
						  <!--<td style="border-right: none;font-weight: 700;">3</td>-->
							...
							<td class="grayed-out"></td>
							<!--<td class="styTableCellTextInherit">
								<xsl:if test="$Form4255Data/TotalAmountsPYCreditsGrp/RecapturePct != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePct"/>
									</xsl:call-template>
								</xsl:if>
								<xsl:if test="$Form4255Data/TotalAmountsPYCreditsGrp/RecapturePctNACd != ''">
									<xsl:call-template name="PopulatePercent">
										<xsl:with-param name="TargetNode" select="RecapturePctNACd"/>
									</xsl:call-template>
								</xsl:if>
      ...
      <table class="border-none" style="width:256mm">
        ...
        <xsl:choose>
			...
			<xsl:otherwise>
				<!-- For Full Schema Table 2  -->
				<xsl:for-each select="$Form4255Data/Form7207PYCreditsGrp">
					<tr>
						<td style="width:3.5mm; border: none; text-align: right; vertical-align:top; padding-right:6px;
						 font-weight: 700;">1a</td>
						<td style="width:12.5mm; border-left: none">Form 7207</td>
					  <!--<td style="width:3.5mm; border-right: none; border-bottom: none; font-weight: 700;">1a</td>
						<td style="width:12.5mm; border-left: none">Form 7207</td>-->
		...
		<xsl:choose>
			...
			<xsl:when test="not($Form4255Data/Form8933PYCreditsGrp)">
				<tr>
					<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
					 font-weight: 700;">2a</td>
					<td style="border-left: none">Form 8833</td>
		...
		<xsl:choose>
			...
			<xsl:when test="not($Form4255Data/Form8911PartIPYCreditsGrp)">
				<tr>
				    <td style="width:3mm; border-right: none; border-bottom: none;
				     border-top: none;padding-left:3.4mm;text-align:center; font-weight: 700;">b</td>
				    <td style="width:12.5mm; border-left: none">Form 8911, Part I</td>
					<td class="styTableCellTextInherit">
					</td>
					<td class="styTableCellTextInherit">
					</td>
			...
			<xsl:otherwise>
				...
				<xsl:for-each select="$Form4255Data/Form8911PartIPYCreditsGrp">
					<tr>
						<td style="border: none; text-align: right; vertical-align:top; padding-right:6px;
						 font-weight: 700;">b</td>
						<td style="border-left: none">Form 8911, Part I</td>
            ...
            <table class="styTable" cellspacing="0" style="border-color:black;">
              ...
              <tr>
                ...
                <td class="styIRS4255TableCellSmallRB " style="width:5mm;padding-top:3mm;font-size:7pt;
                 padding-right:.5mm;font-weight:bold;
                ...
                <td class="styTableCellSmall" style="font-size:6pt;padding-top:3mm;border-style: solid; 
                 border-color: black;">
                  <xsl:call-template name="PopulateAmount">
                    <xsl:with-param name="TargetNode" 
                     select="$Form4255Data/CrtnCrRcptrExPymtPnltyPropGrp[$pos + 1]/CreditBasePYAmt"/>
                  </xsl:call-template>
                  <span class="styTableCellPad"/>  
                </td>
                <td class="styTableCellSmall" style="font-size:6pt;padding-top:3mm;border-style: solid; border-color: black;">
