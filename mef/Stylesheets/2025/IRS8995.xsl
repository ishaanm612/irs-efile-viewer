...
<!DOCTYPE xsl:stylesheet [ <!ENTITY nbsp "&#160;"> <!ENTITY mdash "&#8212;"> ]>
    <!-- Last Modified by Iskilu Lawal on 02/04/2025 drop 1 UWR # 999210 -->
			...
			<body class="styBodyClass">
				...
				<!-- ********************************************************************************************************************* -->
					<div class="styArialText" style="height:20mm;font-size:9pt;width:187mm;border-top:0px solid black;border-bottom:1px solid black;">
						...
						Use this form if your taxable income, before your qualified business income deduction, is at or below $191,950 						   (					  $383,900 if married filing jointly), and you aren’t a patron of an agricultural or horticultural cooperative.</i>
					</div>
			<!-- ********************************************************************************************************************* -->
					<!-- Table 1, cols (a)-(e) -->
						...
						<table style="display:table;border-collapse:collapse;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:38mm;font-weight:normal;vertical-align:top;border-right-width:0px;">
										...
										income or (loss)
										<div style="float:right;width:4mm;height:3.5mm;background-color:red">
							...
							<tbody>
								...
								<xsl:if test="$shouldSeparate or count($FormData/QualifiedBusinessIncomeDedGrp) &lt; 5">
									<tr style="height:7.5mm;vertical-align:top;">
										<td class="styTableCellCtrInherit" style="font-weight:bold;vertical-align:bottom;background-color:red">
