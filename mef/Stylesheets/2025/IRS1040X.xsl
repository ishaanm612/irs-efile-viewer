...
<!-- Last Modified by Sergey Smirnov on 03/04/2025 -->
			...
			<body class="styBodyClass">
				<form id="Form1040X">
						...
						<div class="styIRS1040XHeaderCell" style="width:45.9mm;height:28.5mm;border-right-width:0px;float:right;">
							...
							<span style="font-size:7.5pt;">Check here if you, or your spouse if filing jointly, didn't previously want $3 to go to this fund, but now do. Checking a box below will not change your tax or refund.<br/>
								<input type="checkbox" class="styCkboxNM" style="margin:2mm 0mm 0mm 17mm;"
									aria-label="PECF Primary Ind You">
					...
					<div class="styStdDiv">
						...
						<div class="sty1040XDesc" style="height:9mm;">
							...
							<span style="float:right;">
								...
								<span style="width:4px"/> 
								<input type="checkbox" style="margin-right:6px;" aria-label="NOL Carryback" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
						...
						<div class="sty1040XRightNumBox" style="height:9mm;"><br />1</div>
						<div class="sty1040XAmtBox" style="height:9mm;"><br />
					...
					<div class="styStdDiv">
						...
						<div class="sty1040XDesc" style="height:9mm;">
							...
							<span style="float:right;">
								<span class="sty1040XDotLn" style="float:none;margin-right:-3px;">...........</span>
								<span style="width:4px"/> 
								<input type="checkbox" style="margin-right:6px;" aria-label="business credit carryback" class="styCkbox" >
									<xsl:call-template name="PopulateCheckbox">
						...
						<div class="sty1040XRightNumBox" style="height:9mm;"><br />7</div>
						<div class="sty1040XAmtBox" style="height:9mm;"><br />
							<xsl:call-template name="PopulateAmount">
					...
					<div class="sty1040XDepdContainer" style="">
						<div class="styGenericDiv" style="width:25mm;padding-top:1mm;
							font-family:Arial;font-size:8pt;border-bottom:0px solid black;height:24.3mm;">
							<div style="width:45mm;padding-bottom:3mm;padding-left:1mm;">
						...
						<div class="sty1040XDepdContainer2" style="width:156mm; border-top-width: 0px;" id="depdContainerId">
								...
								<thead class="styTableThead">
									<tr>
										<th class="styTableCellHeader" rowspan="2" scope="col" style="min-width:59.4mm;width:59.4mm;text-align:left;padding-left:1mm;padding-top:.3mm;">
											<span style="font-size:7pt;font-weight:normal;padding-bottom:4px">
												<br/><br/>
								...
								<tbody>
											...
											<tr>
												...
												<td class="styTableCellCtrInherit">
													...
													<input type="Checkbox" class="styCkboxNM" >
														...
														<xsl:attribute name="aria-label">Dependent <xsl:number value="position()"/> Eligible for CTC Indicator</xsl:attribute>
													</input>
												</td>
									...
									<xsl:if test="count($FormData/DependentDetail) &lt; 1 or ((count($FormData/DependentDetail) &gt; 4) and ($Print = $Separated))">
										<tr>
											...
											<td class="styTableCellCtrInherit">
												<span style="width:7mm"/>
												<input type="Checkbox" aria-label="child tax credit 1" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForChildTaxCreditInd"/>
											...
											<td class="styTableCellCtrInherit" style="border-right-width:0px;">
												<span style="width:13mm"/>
												<input type="Checkbox" aria-label="credit for other dependents 1" class="styCkbox" >
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForODCInd"/>
									...
									<xsl:if test="count($FormData/DependentDetail) &lt; 2 or ((count($FormData/DependentDetail) &gt; 4) and ($Print = $Separated))">
										<tr>
											...
											<td class="styTableCellCtrInherit">
												<span style="width:7mm"/>
												<input type="Checkbox" aria-label="child tax credit 2" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForChildTaxCreditInd"/>
											...
											<td class="styTableCellCtrInherit" style="border-right-width:0px;">
												<span style="width:13mm"/>
												<input type="Checkbox" aria-label="credit for other dependents 2" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForODCInd"/>
									...
									<xsl:if test="count($FormData/DependentDetail) &lt; 3 or ((count($FormData/DependentDetail) &gt; 4) and ($Print = $Separated))">
										<tr>
											...
											<td class="styTableCellCtrInherit">
												<span style="width:7mm"/>
												<input type="Checkbox" aria-label="child tax credit 3" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForChildTaxCreditInd"/>
											...
											<td class="styTableCellCtrInherit" style="border-right-width:0px;">
												<span style="width:13mm"/>
												<input type="Checkbox" aria-label="credit for other dependents 3" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForODCInd"/>
									...
									<xsl:if test="count($FormData/DependentDetail) &lt; 4 or ((count($FormData/DependentDetail) &gt; 4) and ($Print = $Separated))">
										<tr>
											...
											<td class="styTableCellCtrInherit">
												<span style="width:7mm"/>
												<input type="Checkbox" aria-label="child tax credit 4" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForChildTaxCreditInd"/>
											...
											<td class="styTableCellCtrInherit" style="border-right-width:0px;">
												<span style="width:13mm"/>
												<input type="Checkbox" aria-label="credit for other dependents 4" class="styCkbox">
													<xsl:call-template name="PopulateCheckbox">
														<xsl:with-param name="TargetNode" select="EligibleForODCInd"/>
