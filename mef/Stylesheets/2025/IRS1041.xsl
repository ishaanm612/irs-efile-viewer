		...
		<html lang="EN-US">
			...
			<body class="styBodyClass" style="width:187mm">
				<form id="Form1041">
					...
					<div style="width:187mm;border-bottom:1px solid black;">
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:0px;background-color:lightgray;"></div>
					...
					<div style="width:187mm;border-bottom:1px solid black;">			
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNRightNumBox" style="height:4mm;width:8mm;border-bottom-width:0px;">22</div>
								<div class="styLNAmountBox" style="border-bottom-width:0px;height:4mm;width:31.5mm; ">
									<xsl:call-template name="PopulateAmount">
					...
					<!--TAX AND PAYMENTS-->
					<div style="width:187mm;border-bottom:1px solid black;">			
						<div style="width:4.8mm;padding-top:0.2mm;float:left;">
							<img src="{$ImagePath}/1041_TaxAndPayments.png" alt="Tax and Payments image" width="14.7"/>
						</div>
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							<!--Line 23-->
							<div style="width:181.8mm;font-size:7pt;float:left;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2025 net 965 tax liability paid from Form 965-A, Part II, column (k), line 5</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="8"/>
										</xsl:call-template>			  
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">Amount on line 29 to be: <b> a Credited to 2025</b><span style="width:2px;" /><!--<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>--></span>				
					...
					<!-- signature -->
					<div class="styBB" style="width:187mm;height:15.5mm;padding-top:0mm;float:left;clear:both;page-break-inside:always;">
                        ...
                        Here
							...
							<div style="width:4mm;padding-top:9.7mm;padding-left:6px;padding-right:0px;float:left;clear:none;border-left:1px solid black;height:15.5mm;">
							</div>
						</div>
                  ...
                  <div>
					  <div style="float:left;">
							<div class="styBB" style="width:136mm;float:left;clear:none;font-size:6pt;">	
									<div class="styFNBox" style="height:6.5mm;width:71mm;padding-top:1mm;float:left;clear:none;"><br />
									...
									<div class="styFNBox" style="height:6.5mm;width:18mm;padding-top:1mm;text-align:center;float:left;clear:none;"><br />
										<xsl:call-template name="PopulateMonthDayYear">
									...
									<div class="styFNBox" style="height:6.5mm;width:46mm;padding-top:1mm;padding-left:2mm;float:left;clear:none;border-right:0px;">
						...
						<div style="width:34.6mm;height:10mm;border:3px solid black;float:right;padding-left:.7mm;padding-top:0mm;font-size:5pt;">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;float:none;clear:both;">
						...
						<div style="width:164mm;float:left;clear:none;border-left:1px solid black;page-break-inside:avoid;">
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:8mm;width:46.8mm;padding-top:0mm;border-right:1px solid black;padding-left:1mm">
							...
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:5.5mm;width:108.5mm;border-right:1px solid black;padding-left:1mm">
								...
								<div class="styLNDesc" style="height:5.5mm;width:32mm;padding-left:1mm;">Firm's EIN
								<!--<img src="{$ImagePath}/1040_Bullet.gif" alt="Right pointing arrowhead image"/>-->
									<span style="width:4px;"/>
			...
			<div style="width:187mm;font-size:7pt;float:left;">
			  ...
			  <div class="styLNDesc" style="width:139.8mm;height:4mm;">
				<span style="float:left;">Tax on the ESBT portion of the trust (from ESBT Tax Worksheet, line 17). See instructions
					...
					<xsl:call-template name="LinkToLeftoverDataTableInline">
						<xsl:with-param name="Desc">Line 4 - Tax on the ESBT portion of the trust - F1041 Total Tax Literal Cd</xsl:with-param>
