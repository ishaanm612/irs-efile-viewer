...
<!-- Form 1040 - TY25 - Last Modified by Yee Chen on 5/12/2025 -->
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form1040">
					...
					<div class="styStdDiv">
						<div class="styIRS1040HeaderCell" style="width:129mm;height:9.5mm;">
						...
						<div class="styIRS1040HeaderCell" style="width:12.06mm;height:9.5mm;font-family:Arial;">
							Apt. no. <br /> &nbsp;
						</div>
						<div class="styIRS1040HeaderCell" style="width:45.9mm;height:25.5mm;border-right-width:0px;float:right;">
					...
					<!-- Digital Assets-->
					<div style="width:187mm;height:8mm;border-bottom:1px solid black">				
					<div style="width:20mm;height:8mm;padding-top:1.25mm;float:left;">
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;">
						<div style="width:20mm;height:6mm;padding-top:2mm;float:left;font-family:Arial;">
							<strong>Age/Blindness</strong>
						</div>
						<div style="width:167mm;height:3mm;padding-top:1mm;float:left;">
							<span style="display:inline;font-family:Arial;">
								<strong>You:</strong>
					...
					<xsl:if test="(count($FormData/DependentDetail) &gt;= 4) and ($Print != $Separated)">
						...
						<div class="sty1040LN" style="height:5mm">
							...
							<div class="sty1040RightNumBox" style="background-color:lightgrey;border-top-width:1px;border-bottom-width:0px;height:10.7mm"></div>
							<div class="sty1040AmountBox" style="background-color:lightgrey;border-top-width:1px;border-bottom-width:0px;border-left-width:0px;height:10.7mm">
							</div>
						</div>
