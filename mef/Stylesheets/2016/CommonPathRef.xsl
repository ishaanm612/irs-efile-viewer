...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
  ...
  <xsl:param name="ScriptPath"><xsl:value-of select="concat('/mef/rrprd/sdi/versioned/',2016,'/scripts')"></xsl:value-of></xsl:param>
  <xsl:param name="ImagePath"><xsl:value-of select="concat('/mef/rrprd/sdi/versioned/',2016,'/images')"></xsl:value-of></xsl:param>
  <xsl:param name="NonVersionedImagePath">/mef/rrprd/common/images</xsl:param>  
  <xsl:param name="CSSPath"><xsl:value-of select="concat('/mef/rrprd/sdi/versioned/',2016,'/styles')"></xsl:value-of></xsl:param>
