...
<!-- 06/25/2024 - defect 1478437 - Jeremy Nichols -->
          ...
          <span class="IRS8865_DotSpacing">....</span>
				...
				<div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1px solid black;">
					...
					<div style="float:right;">
					  ...
					  Form <span class="styBoldText" style="font-size:8pt;">8865</span> (2024)
					</div>
				</div>
				...
				<div style="width:187mm;padding-top:.5mm;border-bottom:1px solid black;">
					<div style="float:left;">Form 8865 (2024)<span style="width:148mm;"/>
					</div>
             ...
             Type <img src="{$ImagePath}/8865_Bullet_Sm.gif" alt="right arrow"/>
				...
				<div class="IRS8865_LineContainer">
					...
					<div class="IRS8865_LineDescLongSchK" style="height:50mm;padding-top:20mm;width:134mm;border-right-width:1px;border-bottom:1px solid black;">
						...
						<input type="checkbox" alt="international tax relevance" >
							<xsl:call-template name="PopulateCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/IRS8865ScheduleK/IntntlTaxRelevanceRptgInd"/>
							</xsl:call-template>
						</input>
