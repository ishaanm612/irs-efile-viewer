...
<!-- Last Modified by Sergey Smirnov on 12/20/2023 -->
			...
			<body class="styBodyClass">
				<form id="Form1040NR">
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;">
						...
						<div style="width:167mm;min-height:15mm;padding-top:1.0mm;
							...
							<span style="display:inline;font-family:Arial;font-size:9pt">
								...
								<span style="width:3mm;"/>
								<input type="checkbox" class="styCkboxNM" style="margin-right:1mm;"
									alt="Qualifying surviving spouse (QSS)">
									<xsl:call-template name="PopulateEnumeratedCheckbox">
										<xsl:with-param name="TargetNode" 
										select="$FormData/IndividualReturnFilingStatusCd"/>
					...
					<div class="styStdDiv">
						...
						At any time during 2024, did you: (a) receive (as a reward, award, or payment for property or services); or (b) sell, exchange,<br/>or otherwise dispose of a digital asset (or a financial interest in a digital asset)? (See instructions). 
...
EligibleForODCInd</xsl:with-param>
							...
							<div class="sty1040NRDesc" style="width:49mm;">
								Taxable amount
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										...
										<xsl:with-param name="TargetNode" select="$FormData/TotalTaxablePensionsAmt/attribute::pensionsAnnuitiesLiteralCd"/>
									</xsl:call-template>
								<span class="sty1040NRDotLn">.....</span>
							</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;font-size:6.5pt;">Form <strong>1040-NR</strong> (2024)
						</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv" style="border-bottom:1px solid black;">
					...
					<div class="sty1040NRLN">
						...
						<div class="sty1040NRDesc" style="width:87mm;">
							<span style="display:inline;font-family:Arial;">Amount of line 34 you want
								<strong>applied to your 2025 estimated tax </strong></span>
							<span class="sty1040NRDotLn" style="padding-right:0px;
								margin-right:8px;">..
							</span>
						</div>
						...
						<div style="width:167mm;height:7mm;">
							<span style="">
								...
								<span style="width:59mm;float:right;">
									...
									<span style=""> Complete below.</span>
									<span style="width:10px"/>
									<input type="checkbox" class="styCkboxNM" style="margin-right:2px;"
			...
			select="$RtnHdrData/PaidPreparerInformationGrp/PreparerFirmName/BusinessNameLine2Txt"/>
				...
				<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
					...
					<span style="float:right;font-size:6.5pt;">Form <strong>1040-NR</strong> (2024)</span>
				</div>
