...
<!-- Last Modified by Yee Chen on 7/10/2024 - 1040 SCH 3 - 2024-->
			...
			<body class="styBodyClass">
				<form id="Form1040Schedule3">
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;font-weight:bold;font-size:6.5pt;">Schedule 3 (Form 1040) 2024
						</span>
					</div>
					<!-- Part 2 -->
					<div class="styStdDiv" style="border-bottom:1px solid black;font-size:7pt;font-family:Verdana;">Schedule 3 (Form 1040) 2024
						...
						<div class="styLNDesc" style="width:98mm;font-size:8pt">
							...
							<span style="width:95mm;border-bottom:1px solid black;">
								<xsl:if test="count($FormData/OtherRefundableCreditsGrp) &lt; 2">
									<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Line 13z - Other Refundable Credits Group</xsl:with-param>
										<xsl:with-param name="TargetNode"
						...
						<xsl:if test="count($FormData/OtherRefundableCreditsGrp) &gt; 1">
						  <table class="styDepTbl" cellspacing="0" style="font-size:7pt;width:120mm;">
							...
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:32mm;">
										Other Refundable Credit Code
									</th>
									<th class="styDepTblCell" scope="col" style="width:32mm;">
										Other Refundable Credit Text
									</th>
									<th class="styDepTblCell" scope="col" style="width:32mm;">
										Other Refundable Credit Amount 
									</th>
								</tr>
							</thead>
							<tbody>
								<xsl:for-each select="$FormData/OtherRefundableCreditsGrp">
									<tr style="border-color:black;height:6mm;">
										...
										<td class="styTableCellTextInherit">
											<xsl:call-template name="PopulateText">
												<xsl:with-param name="TargetNode" select="OtherRefundaebleCrTxt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit">
											<xsl:call-template name="PopulateAmount">
