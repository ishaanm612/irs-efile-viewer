...
<div class="IRS990ScheduleE_LineContainer" style="height:24mm;border-bottom:1px solid black;padding-bottom:0;">
  ...
  <div class="IRS990ScheduleE_FormTitleBlock" style="height:24mm;width:128mm;padding-top:.5mm;padding-bottom:2.5mm;">
    ...
    <span style="font-size:6pt;font-weight:bold;padding-bottom:1mm;"><img src="{$ImagePath}/990SchF_Bullet_Line.gif" alt="Right pointing arrow large image" width="6"/> Go to <i>www.irs.gov/Form990EZ</i> for instructions and the latest information. </span><br/>
  </div>
