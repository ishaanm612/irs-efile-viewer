	...
	<div class="styBB" style="width:187mm;border-bottom-width: 0px;float:none;clear:both;height:auto;">        
		...
		<div class="styGenericDiv" style="width:187mm;border-bottom-width: 0px;">        
			...
			<div class="styGenericDiv" style="width:159mm;padding-top:0mm;">
				<span style="float:left;">Did you make any payments in 2024 that would require you to file Form(s) 1099? See instructions</span>
		...
		<tbody>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:49mm;padding-top:0.5mm;"> 
				    <span style="float:left;padding-left:1mm;">Energy efficient commercial bldgs deduction (attach Form 7205)
				    <xsl:call-template name="SetFormLinkInline">
...
<!--Dotted Line-->
				...
				<td class="styLNRightNumBox" style="height:8mm;width:7.25mm;border-bottom-width:0px;padding-top:4mm">
					27b
				</td>
				<td class="styLNAmountBox" style="height:8mm;width:31.5mm;border-bottom-width:0px;padding-top:4mm"> &#160;    
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/EnergyEffcntCmrclBldgDedAmt" />
					</xsl:call-template>
				</td>      
...
<div style="width:187mm;float:none;clear:both; ">  
	...
	<div class="styGenericDiv" style="font-weight:bold;float:right">Schedule C (Form 1040) 2024 </div>
</div> 
<!--</div> --> 
 <!--Begin Page 2 -->
...
<p style="page-break-before: always"/>
    ...
    <div class="styBB" style="width:187mm;float:left;clear:all;">  
      <div style="float:left;">Schedule C (Form 1040) 2024 <span style="width:90mm;"/></div>
 ...
 <!--Line 41-->   
	...
	<div style="height:auto;">	  
		<div class="styBB" style="width:187mm;height:auto;">
			...
			<span class="styNormalText"> List below business expenses not included on lines 8-26, 27b, or line 30.
			</span> 
		</div>	
		<!--Table-->
		<!-- Table expand/collapse toggle button -->
  ...
  <!--Line 48-->
    ...
    <div style="width:187mm;clear:all;">    
      ...
      <div class="stySmallText" style="width:52mm;text-align:right;"><span class="styBoldText" style="font-weight:bold;">Schedule C (Form 1040) 2024</span> </div>
    </div>
    <!--    </div> -->      
