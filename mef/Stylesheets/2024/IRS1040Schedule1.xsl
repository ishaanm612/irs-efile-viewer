...
<!-- Last Modified by Yee Chen on 6/12/2024 - 1040 SCH 1 - TY 2024-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<!--<div class="styLNLeftNumBoxSD" style="height:100%;">1</div>-->
		...
		<span style="width:140mm;height:12mm;padding-bottom:4mm">		
				<span>For 2024, enter the amount reported to you on Form(s) 1099-K that was included in error or for personal items sold at a loss.</span>
				<span style="width:140mm;height:12mm;padding-bottom:4mm">
...
<!--/div-->
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;font-weight:bold;font-size:6.5pt;">Schedule 1 (Form 1040) 2024
						</span>
					</div>
					<!-- Part 2 -->
					<div class="styStdDiv" style="border-bottom:1px solid black;font-size:7pt;font-family:Verdana;">Schedule 1 (Form 1040) 2024
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						<span style="float:right;font-weight:bold;font-size:6.5pt;">Schedule 1 (Form 1040) 2024</span>
					</div>
