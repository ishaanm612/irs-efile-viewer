		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form8995A">
					...
					<br/>
					<span style="width:10px;"></span>Use this form if your taxable income, before your qualified business income deduction, is above $191,950 ($383,900 if married filing jointly), or you’re a patron of an agricultural or horticultural cooperative.
						</div>
					<!-- Part 1 -->
						...
						<xsl:if test="position() mod 3 = 1">
							...
							<div class="styStdIBDiv">
								...
								<div class="sty8995ADesc" style="height:10mm;">
									Multiply line 2 by 20% (0.20). If your taxable income is $191,950 or less 
									($383,900 if married filing jointly), skip lines 4 through 12 and enter the amount from line 3 on line 13
									<span class="sty8995ADotLn">..</span>
								</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;">Form <span style="font-weight:bold;font-size:larger;">8995-A</span> (2024)</span>
					</div>
					<div class="styStdDiv">
						Form 8995-A (2024)
					...
					<div class="styStdDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;font-family:Arial;">
						Complete Part III only if your taxable income is more than $191,950 but not $241,950 ($383,900 and $483,900 if married filing jointly) and line 10 is less than line 3. Otherwise, skip Part III.
					</div>
					<xsl:for-each select="$FormData/QBIDeductionInformationGrp">
						<xsl:if test="position() mod 3 = 1">
							<xsl:variable name="pos" select="position()"/>
