					...
					<div class="styBB" style="width:187mm;font-size:7pt;border-bottom-width:2px;height:7.5mm;">
						<div class="styFNBox" style="width:187mm; height:7mm;border-right-width: 0px;">
							<xsl:call-template name="PopulateLabel">
								<xsl:with-param name="TargetNode" select="$Form2441Data/EligibilityRequirementMetInd"/>
								<xsl:with-param name="BackupName">Eligbility requirement met indicator</xsl:with-param>
							</xsl:call-template><b>B</b> If you or your spouse was a student or was disabled during 2024 and you're entering deemed income of $250 or $500 a month on Form 2441 based on the income rules listed in the instructions under <i>If You or Your Spouse Was a Student or Disabled,</i> check this box
							<!--Dotted Line-->
				     <span style="float:right;">
...
Did you receive<br/>
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:123mm;height:5mm;">If you paid 2023 expenses in 2024, complete Worksheet A in the instructions. Enter the amount from line 13 of the worksheet here. Otherwise, enter -0- on line 9b and go to line 9c
                             <!--CPYECreditAmt-->
									<xsl:call-template name="SetFormLinkInline">
					...
					<div class="stySmallText" style="width:36mm;text-align:right;">Form <span class="styBoldText">2441</span> (2024)
                   </div>
					</div>
					<!--End Footer-->
					<!-- Page Header -->
					...
					<div class="styStdDiv">
						<div style="float:left;">Form 2441 (2024)<span style="width:148mm;"/>
						</div>
					...
					<div style="width:187mm;clear:all;">
						...
						you received in 2024. Amounts you<br/> received as an employee should be shown in box 10 of your Form(s) W-2. 
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:8mm;padding-top:1mm;">Enter the amount, if any, you carried over from 2023 and used in 2024 during the grace period. See instructions
						<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.........................</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:123mm;height:7mm;padding-top:1mm;">If you forfeited or carried over to 2025 any of the amounts reported on line 12 or 13, enter the amount. See instructions
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:91mm;height:4mm;">
							<span style="width:8mm"/>in 2024 for the care of the <span class="styBoldText">qualifying person(s)</span>
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
						</div>
  ...
  If married filing separately, see<br/>
		...
		<div class="styLNDesc" style="width:83mm;padding-top:0mm;height:13mm;">Enter $5,000 ($2,500 if married filing separately <b>and</b> <br/>you were required to enter your spouse's earned <br/>income on line 19). However, don't enter more than the maximum amount allowed under your dependent care plan.<br></br> See instructions
					...
					<div style="width:187mm;">
						...
						You can't take the credit. <br/><b>Exception.</b> If you paid 2023 expenses in 2024, see the instructions for line 9b
							<!--Dotted Line -->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>
						</div>
					...
					<div class="pageEnd" style="width:187mm; border-top:0.5mm solid black;">
						<div style="float:right;">
							<span style="width:80px;"/>  
                             Form <span class="styBoldText">2441</span> (2024)
                    </div>
					</div>
					<!--END Page Footer-->
 ...
 (see instructions)  
      ...
      <br/> First<span style="width:40mm"/>Last
									...
									<th class="styDepTblCell" scope="col" colspan="1" style="width:49mm;font-weight:normal;vertical-align:top;">
										<span style="font-weight:bold;"></span>  <span style="height:3mm;padding-bottom:5mm">(d) Qualified expenses you<br/> incurred and paid in 2024 for the person listed in column (a)  	</span>
                                </th>
								</tr>
							</thead>
							<tfoot/>
