         ...
         Employer identification number<br/>
							...
							<tr style="height:8mm">
							  <td class="styTableCell" style="width:4mm;text-align:right;border-right-width:0px;
								...
								<td class="styTableCell" style="text-align:left;width:56mm;padding-top:0px;padding-left:14px">
								  Totals for all short-term transactions reported on Form 1099-B for which basis was reported to the IRS and for which you have no adjustments
					...
					<table class="styTable" style="width:187mm;height:auto;" cellspacing="0">
						...
						<tfoot/>
							<tbody style="font-size:7pt">
								...
								<td class="styTableCell" style="text-align:left;width:56mm;padding-top:0px;padding-left:14px">
								  Totals for all long-term transactions reported on Form 1099-B for which basis was reported to the IRS and for which you have no adjustments
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;font-size:7pt">
						...
						<div style="float:right;">
							<span class="styBoldText">Schedule D (Form 1065) 2024</span>
						</div>
					</div>
