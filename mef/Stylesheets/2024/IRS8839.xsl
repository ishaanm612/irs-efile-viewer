...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
 ...
 <!--               <div style="width:187mm;">
            ...
            <div class="styIRS8839LineItem" style="height:7mm;">
              ...
              <div class="styIRS8839LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8839LNDesc" style="width:auto;height:100%;">
                  Credit carryforward, if any, from prior years. See your Adoption Credit Carryforward Worksheet in the<br/>2023 Form 8839 instructions
                  <!--Dotted Line-->
            ...
            <div style="float:left;clear:both;">
              <span class="styBoldText">
                ...
                <span style="font-size:7pt;">			   Cat. No. 22843L					</span>
                 <span style="width:24mm;"/>   Form <span class="styBoldText" style="font-size:8pt;">8839</span> (2024)
            </div>
          </div>
		  ...
		  <xsl:otherwise>
               ...
               <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
                 ...
                 child with special needs and the<br/>
                  adoption became final in 2024,<br/>
...
<!--                <div style="width:187mm;">
          ...
          <div class="styTBB" style="width:187mm;height:25mm;">
            <div class="styIRS8839LineItem">
              ...
              <div class="styIRS8839LNDesc" style="width:88%;height:100%;padding:0px 0px 0px 0px;">
                ...
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/><i>You paid adoption expenses in 2023, those expenses were not fully reimbursed by your employer or otherwise, <br/>
                  <span style="width:10px;"/>and the adoption was not final by the end of 2023</i>.
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 0px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/><i>The total adoption expenses you paid in 2024 were not fully reimbursed by your employer or otherwise, <br/>
                  <span style="width:10px;"/>and the adoption became final in 2024 or earlier.</i>
                </div>
                <div class="styIRS8839LNDesc" style="width:100%;height:auto;padding:5px 0px 5px 5px;">
                  <img src="{$ImagePath}/8839_Bullet_Round.gif" alt="RoundBullet"/><span style="width:4px;"/><i>You adopted a child with special needs and the adoption became final in 2024.</i>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;clear:both;">
            <div style="float:right;">
              ...
              Form  <span class="styBoldText" style="font-size:7pt;">  8839 </span> (2024)
            </div>
          </div>
          <!-- END Page Break and Footer-->
  ...
  <xsl:template name="CreateTableHeaders">
    ...
    <tr>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="3">
        ...
        <br/>Check if<br/>adoption<br/>became final in 2024 or earlier</th>
    </tr>
    <tr>
      <xsl:if test="$AddColoredHeaders">
        <xsl:attribute name="class">styDepTblHdr</xsl:attribute>
      ...
      <th class="styTableCellHeader" scope="col" rowspan="2">
        ...
        <br/>born <b>before<br/>2007</b> and<br/>disabled</th>
      <th class="styTableCellHeader" scope="col" rowspan="2">
        <xsl:attribute name="style">
          border-color:black;width:8mm;font-weight:normal;
          <xsl:if test="$AddColoredHeaders">
		  ...
		  <div class="styIRS8839LNDesc" style="width:48mm;height:100%;padding:5px 0px 0px 0px;">
			<div class="styIRS8839LNDesc" style="width:auto;height:auto;">
			 ...
			 <span> See instructions</span>
			  ...
			  <br/>
			  <b>Caution:</b>
			  <span style="width:7px;"/>Your qualified adoption expenses may not be equal to the adoption expenses you paid in 2024.
		  </div>
      </div>
      <div class="styIRS8839LNDesc" style="height:100%;width:132mm;float:right;padding:0px 0px 0px 0px;">
        <xsl:call-template name="CreateBoxRow">
    ...
    <div class="styIRS8839LineItem" style="height:18mm;">
      ...
      <div class="styIRS8839LNDesc" style="width:48.5mm;height:100%;padding:0px 0px 0px 0px;">
        <div class="styIRS8839LNDesc" style="width:auto;height:auto;">
          ...
          benefits you received in 2024.<br/>
          This amount should be shown<br/>
          in box 12 of your 2024 Form(s)<br/>
          W-2 with code <b>T</b>
          <!--Dotted Line-->
