				...
				<form id="Form1065ScheduleK2" style="width:256mm;">
					...
					<div class="styStdDivLS">
						...
						<div class="styTYBox" style="width:33mm;height:18mm;">
							...
							<div class="styTY" style="margin-top:1mm;">20<span class="styTYColor">24</span></div>
						</div>
					</div>
					...
					<div class="styStdDivLS pageEnd" style="border-top:2px solid black;font-weight:bold;">
						...
						<span style="float:right;">Schedule K-2 (Form 1065) 2024</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDivLS">
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							...
							<tbody>
								...
								<tr style="vertical-align:bottom;">
									...
									<td class="styTableCellTextInherit">
										Other income not included on lines 1 through 19
										<span class="sty1065K2DotLn">.........</span>
									</td>
									<xsl:call-template name="LinePartnerDetermination">
							...
							<thead class="styTableThead">
								<tr style="border-top:1px solid black;">
									...
									<th class="styTableCellHeader" scope="col" style="width:50mm;font-weight:normal;border-right-width:0px;">
										<strong>(e)</strong> Total of (iii) and (iv) <br /> (enter four decimal places)
									</th>
								</tr>
							</thead>
							<tbody>
					...
					<div class="styStdDivLS" style="border-bottom:1px solid black;">
						<div class="styNameBox" style="width:205mm;font-size:7pt;">
							Name of QDD <br />
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/QDDName/BusinessNameLine1Txt"/>
							</xsl:call-template>
							<xsl:if test="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/QDDName/BusinessNameLine2Txt">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/QDDName/BusinessNameLine2Txt"/>
								</xsl:call-template>
							</xsl:if>
						</div>
						<div class="styNameBox" style="width:46mm;padding-left:1mm;padding-top:4mm;font-weight:normal;font-size:7pt;border-right:0;">
								Schedule
							<span style="width:12mm;text-align:center;border-bottom:1px solid black;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/QDDScheduleNum"/>
								</xsl:call-template>
							</span>
									of
							<span style="width:12mm;text-align:center;border-bottom:1px solid black;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/TotalQDDScheduleNum"/>
								</xsl:call-template>
							</span>
						</div>
					<div class="styStdDivLS" style="border-top:1px solid black;">
							...
							<div class="styStdDivLS">
								...
								<strong>Beginning</strong>
									...
									<span style="width:25mm;border-bottom:solid black 1px;text-align:center;">
										<xsl:call-template name="PopulateMonthDayYear">
											<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/BeginDt"/>
										</xsl:call-template>
									</span>
										<strong>, and ending</strong>
											...
											<span style="width:25mm;border-bottom:solid black 1px;text-align:center;">
												<xsl:call-template name="PopulateMonthDayYear">
													<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/EndDt"/>
												</xsl:call-template>
											</span>
							</div>
						</div>
					...
					<!-- Part 12 tables -->
					<xsl:variable name="sep12" select="($Print = $Separated) and (count($FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/TotQDDTaxPerSect309CIncmGrp) &gt; 7)"/>
					<div class="styTableContainerLandscapeNBB" id="Page19Table1">
						<xsl:call-template name="SetInitialState"/>
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								<tr style="border-top:1px solid black;">
									<th class="styTableCellHeader" scope="col" style="width:8mm;border-right:none;">&nbsp;</th>
									<th class="styTableCellHeader" scope="col" style="width:152mm;font-weight:normal;font-size:8pt;border-left:none;">
									...
									<th class="styTableCellHeader" scope="col" style="width:32mm;font-weight:normal;font-size:6.5pt;border-right:none;">
										<strong>(c)</strong> Amount of tax liability (column (a) x column (b))
									</th>
								</tr>
							</thead>
							<tbody>
								<xsl:for-each select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]">
									<tr style="vertical-align:bottom;">
										<td class="styTableCellCtrInherit" style="font-weight:bold;border-bottom:1px solid black;border-right:none;text-align:center;padding-right:3px;">1</td>
										<td class="styTableCellTextInherit" style="">
									...
									<tr style="vertical-align:bottom;">
										<td class="styTableCellCtrInherit" style="font-weight:bold;border-bottom:1px solid black;border-right:none;text-align:center;padding-right:3px;">2</td>
										<td class="styTableCellTextInherit" style="">
									...
									<tr style="vertical-align:bottom;">
										<td class="styTableCellCtrInherit" style="font-weight:bold;border-bottom:1px solid black;border-right:none;text-align:center;padding-right:3px;">3</td>
										<td class="styTableCellTextInherit" style="">
									...
									<tr style="vertical-align:bottom;">
										<td class="styTableCellCtrInherit" style="font-weight:bold;border-bottom:1px solid black;border-right:none;text-align:center;padding-right:3px;">4</td>
										<td class="styTableCellTextInherit" style="">
									...
									<tr style="vertical-align:bottom;">
										<td class="styTableCellCtrInherit" style="font-weight:bold;border-bottom:none;border-right:none;text-align:center;padding-right:3px;">5</td>
										<td class="styTableCellTextInherit" style="border-bottom:none;">
									...
									<xsl:for-each select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/TotQDDTaxPerSect309CIncmGrp">
										<tr style="vertical-align:bottom;">
											<!--<td class="styTableCellCtrInherit" style="font-weight:bold;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="AlphaRowId"/>
											...
											<td class="styTableCellCtrInherit" style="font-weight:bold;border-bottom:none;border-right:none;padding-left:5px;">a</td>												
											<td class="styTableCellTextInherit" style="border-bottom:none;">
												Income type:
										...
										<xsl:if test="$sep12 or (count($FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/TotQDDTaxPerSect309CIncmGrp) &lt; 7)">
											<xsl:call-template name="FillTable5ColsPart12">
												<xsl:with-param name="LineNumber" select="1 + count($FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]/TotQDDTaxPerSect309CIncmGrp)"/>
									...
									<tr style="vertical-align:bottom;">
										<td class="styTableCellCtrInherit" style="font-weight:bold;border-bottom:none;border-right:none;text-align:center;padding-right:3px;">6</td>
										<td class="styTableCellTextInherit" style="border-bottom:none;">
					...
					<!--<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="height:10.5mm;width:152mm;font-size:8pt;font-weight:bold;text-align:center;padding-top:3mm;border-bottom:1px solid black;">Summary of QDD Tax Liability</div>
						<div class="styLNAmountBox" style="height:10.5mm;padding-top:3mm;text-align:center;display-align:center;">
							<strong>(a)</strong> Gross amount
						</div>
						<div class="styLNAmountBox" style="height:10.5mm;padding-top:3mm;text-align:center;">
							<strong>(b)</strong> Withholding tax rate
						</div>
						<div class="styLNAmountBox" style="height:10.5mm;text-align:center;">
							<strong>(c)</strong> Amount of tax <br /> liability (column (a) x column (b))
						</div>
					</div>
					--><!-- Part 12, Line 1 --><!--
					<div class="styStdDivLS">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNAmountBox" style="border-right-width:0px;border-bottom-width:0px;background-color:lightgrey;"/>
						<div class="styLNAmountBox" style="border-right-width:0px;border-bottom-width:0px;background-color:lightgrey;"/>
						<div class="styLNAmountBox" style="border-right-width:0px;border-bottom-width:0px;background-color:lightgrey;"/>
					</div>
					--><!-- Part 12, Line 5a --><!--
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:152mm;">
								Income type:
							<span style="width:132mm;text-align:left;border-bottom:solid black 1px;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotQDDTaxPerSect309CIncmGrp/IncomeTypeDesc"/>
								</xsl:call-template>							
							</span>
						</div>
						<div class="styLNAmountBox" style="padding-right:0.5mm;">
						...
						<div class="styLNAmountBox" style="padding-right:0.5mm;">
							<xsl:call-template name="PopulatePercent">
								<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309CGrp/WithholdingTaxRt"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNAmountBox" style="padding-right:0.5mm;border-bottom:0px solid black;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309CGrp/GrossAmt"/>
							</xsl:call-template>
						</div>
