...
<!--F8840 Last modified by Yee Chen - 02/14/2024-->
				...
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						...
						<div class="styFTBox" style="width:128mm;height:20mm;">
							...
							<br/>
							<span>
								For the year January 1 &#8212; December 31, 2024, or other tax year<br/>beginning 
						...
						<div class="styTYBox" style="width:28mm;height:20mm;border-left-width:2px;">
							...
							<div class="styTaxYear" style="width:100%;">20<span style="display:inline;" class="styTYColor">24</span>
							</div>
							<div style="width:100%;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							During 2024, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status in <br/>
					...
					<div class="styStdDiv" style="margin-top:3mm;">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:56mm;">Where was your tax home during 2024?</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Enter the name of the foreign country to which you had a closer connection than to the United States during 2024. <br/>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Where was your tax home on January 1, 2024?
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							After changing your tax home from its location on January 1, 2024, where was your tax home for the remainder of 2024?<br/>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							...
							10 during all of the 2024 or <strong>(b)</strong> both of the countries listed on lines 9 and 10 for the period during which you <br/>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Have you filed or will you file tax returns for 2024 in the countries listed on lines 9 and 10? <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:8px;">.........</span>
							<span style="float:right;">
								<xsl:call-template name="PopulateSpan">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8840</span> (2024)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:2px solid black;">
						...
						<div class="styPartDesc">Significant Contacts With Foreign Country or Countries in 2024</div>
					</div>
					<!-- Line 14 -->
					<div class="styStdDiv" style="margin-top:3mm;">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:120.5mm;float:left;">
								Where was your regular or principal permanent home located during 2024? See instructions.
							</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							If you had more than one permanent home available to you at all times during 2024, list the location of each and <br/>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:104mm;float:left;">
								From what country or countries did you derive the majority of your 2024 income?
							</span>
