...
<!--Last modified by Ashleigh Smith on 08/12/2024-->
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form8997">
					...
					<div class="styStdDiv" style="font-size:8pt;font-weight:bold;padding:2px 0px;border-bottom:1px solid black;border-top:1px solid black;">
						Waiver of Treaty Benefits on Future Inclusion by a Foreign Eligible Taxpayer (for Tax Years Beginning After March 13, 2020, Only)
					</div>
					<div class="styStdDiv" style="padding:2px 0px 2px 6px">
						<xsl:call-template name="PopulateSpan">
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>8997</strong> (2024)</span>
					</div>
					<!-- Page 2 -->
