	...
	<xsl:template match="/">
				...
				<form id="Form1041">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div style="width:187mm;height:14mm;">
							<div class="styGenericDiv" style="width:130mm;height:10mm;">
								...
								<div class="styGenericDiv" style="float:right;padding-right:19mm;padding-top:6px;width:100mm;height:10mm;">
							...
							<div class="styGenericDiv" style="width:21mm;height:14mm;border-right:2px solid black;border-left:2px solid black;padding-top:2mm;padding-left:9px;padding-right:8px;">
								<span class="styTaxYear">20<span class="styTYColor">24</span></span>
							</div>
							<div class="styOMB" style="width:34.5mm;height:14mm;padding:5mm 1mm 1mm 5mm;float:left;border-width:0px 0px 0px 0px;vertical-align:bottom;">
							OMB No. 1545-0092
							</div>						
						</div>
					</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:146.9mm;height:59.6mm;float:left;border-left:1px solid black;">
							<div class="styBB" style="width:146.9mm;height:5mm;padding-top:1mm;padding-left:1mm;">For calendar year 2024 or fiscal year beginning 
					...
					<div style="width:187mm;border-bottom:1px solid black;">			
						...
						<div style="width:181.8mm;float:left;border-left:1px solid black;">
							...
							<div style="width:181.8mm;font-size:7pt;float:left;">
								...
								<div class="styLNDesc" style="width:134.3mm;height:4mm;">
									<span style="float:left;">2024 net 965 tax liability paid from Form 965-A, Part II, column (k), line 5</span>
									<span class="styBoldText" style="float:right;padding-right:10px;">
										<xsl:call-template name="DotLoop">						
											<xsl:with-param name="DotQty" select="8"/>
										</xsl:call-template>			  
                  ...
                  <div>
					  <div style="float:left;">
						...
						<div style="width:34.6mm;height:12.5mm;border:3px solid black;float:right;padding-left:.7mm;padding-top:.5mm;font-size:5pt;">
					...
					<div class="styBB" style="width:187mm;font-size:6pt;float:none;clear:both;">
						...
						<div style="width:164mm;float:left;clear:none;border-left:1px solid black;page-break-inside:avoid;">
							...
							<div style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:6.5mm;width:108.5mm;border-right:1px solid black;padding-left:1mm">
		...
		<div class="pageEnd" style="width:187mm;">
			...
			<span style="float:right;clear:none;">
               Form <span class="styBoldText" style="font-size:10pt;">1041</span> (2024)
            </span>
		</div>
		<!-- end page 1 footer -->
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;">
			<span class="" style="float:left;clear:none;">Form 1041 (2024)</span>
		...
		<!--Line 1-->
		  ...
		  <!--Line 3 (1)-->
			<div style="width:187mm;font-size:7pt;float:left;">
			  <div class="styLNLeftNumBoxSD" style="height:4mm;">3</div>
			  <div class="styLNDesc" style="width:159mm;height:4mm;">
				<span style="float:left;width:158.9mm;height:auto;">At any time during calendar year 2024, did the estate or trust have an interest in or a signature or other authority</span>
