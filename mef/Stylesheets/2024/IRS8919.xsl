				...
				<form name="Form8919">
					...
					<div style="width:187mm;border-bottom:none;">
						...
						<div class="styCodes" style="width:187mm; height:auto;font-size:7.5pt;padding-left:17mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
							...
							<span style="width:161mm;float:left;">
									I received a Form W-2 and a Form 1099-MISC and/or 1099-NEC from this firm for 2024. The amount on Form 1099-MISC and/or 1099-NEC should have been included as wages on Form W-2. <b>(Don't file Form SS-8 if you select reason code H.)</b>
							</span>
						</div>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:139.60mm;height:auto;float:left;padding-top:1mm;">
							<div style="float:left;">Add lines 11 and 12. Enter here. Include as tax on your annual tax return (Schedule 2 (Form 1040), line 6 or Form 1040-SS, Part I, line 6). See the instructions there
									<!--Dotted Line-->
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:2px solid black; padding-top:0.5mm;text-align:right;">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
								  Form <span class="styBoldText" style="font-size:8pt;">8919</span> (2024)
								</div>
					</div>
