			...
			<body class="styBodyClass">
              ...
              Foreign Taxes Paid or Accrued <span class="styNormalText">(see instructions)</span>
					...
					<div class="pageEnd" style="width:187mm;border-top:0.4mm solid black;clear:all;">
                        ...
                        <div class="stySmallText" style="width:36mm;text-align:right;">Form <span class="styBoldText">1116</span> (2024)
                   </div>
					</div>
					<!--End Footer-->
					...
					<div class="styStdDiv">
						<div style="float:left;">Form 1116 (2024)<span style="width:148mm;"/>
						</div>
					...
					<div class="pageEnd" style="width:187mm; border-top:0.5mm solid black;">
						<div style="float:right;">
							<span style="width:80px;"/>  
                             Form <span class="styBoldText">1116</span> (2024)
                    </div>
					</div>
