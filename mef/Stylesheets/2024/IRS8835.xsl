...
<!DOCTYPE xsl:stylesheet [
	<!ENTITY nbsp "&#160;">
	<!-- 12/20/2024 - Changes for 995169 MD1 - AJH -->
]>
				...
				<form name="Form8835">
					...
					<div class="styBB" style="width:187mm;height: auto">
						...
						<div class="styTYBox" style="width:30mm;height:auto; border-left-width: 1px">
							...
							<div class="styTaxYear" style="height:auto">20<span class="styTYColor">24</span>
							</div>
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="width:179mm;height:auto;">
							If making an elective payment election or transfer election, enter the IRS-issued registration number of the facility:
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="width:35mm;">and <strong>(ii)</strong> owner's TIN</div>
					...
					<!--Line 4 -->
						...
						<div style="width:177mm;">
							...
							<div class="styLNDesc" style="width:155mm;height:8mm;">
							 Is this facility part of an expansion of an existing closed-loop biomass or open-loop biomass
							  facility?
...
45(b)(8).
						...
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="padding-left:4mm;">a</div>
								<input type="checkbox" 
								   alt="Qualify domestic bonus credit" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" 
						...
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="padding-left:4mm;">b</div>
								<input type="checkbox" alt="Qualify domestic bonus credit" class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/PropertyQualifyDomBonusCrInd"/>
										<xsl:with-param name="BackupName">PropertyQualifyDomBonusCrInd</xsl:with-param>
									</xsl:call-template>
						...
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="padding-left:4mm;">a</div>
								<input type="checkbox" 
								   alt="Energy community bonus credit" class="styCkbox">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" 
						...
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="padding-left:4mm;">b</div>
								<input type="checkbox" 
								   alt="Energy community bonus credit" 		
								   class="styCkbox">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" 
										 select="$FormData/QlfyEgyComBonusCrInd"/>
						...
						<div style="width:187mm;">
							<div class="styLNLeftNumBox" style="padding-left:4mm;">c</div>
								<input type="checkbox" alt="Energy community bonus credit N/A">
									<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;border-top:2px solid black;">
						...
						<span style="float: right">
						  Form <span class="styBoldText">8835</span> (2024)
						</span>
					</div>
					<div class="pageEnd"/>
					<br/>
					...
					<div style="width: 187mm">
						...
						<div class="styLNDesc" style="width: 137mm;">
							 Subtract line 7g from line 6 
							 	<div style="width:2mm;">
								<div class="styDotLn" style="float: none;padding-left:3mm;">  
							  .....................
							</div>
							</div>
