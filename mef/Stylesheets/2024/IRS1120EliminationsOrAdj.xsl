				...
				<!-- *******************************************************************************************************  -->		
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<div class="styFTBox" style="width:123mm;height:19mm;">
							...
							<div class="styFST" style="height:5mm;text-align:center;padding-top:1mm;">For calendar year 2024 or tax year beginning
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styGenericDiv" style="width:181mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:132mm;">
									<span style="float:left;">Total payments and credits (Schedule J, line 23)
			                    	  </span>
									<!--Dotted Line-->
									<div class="styDotLn" style="float:right;padding-right:1mm;">................</div>
								</div>
					...
					<p>
						<div class="pageEnd" style="width:187mm;padding-top:0mm;border-top-width:1px;">
							...
							<div style="float:right;">
								<span style="width:40px;"/>Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2024)
                           </div>
						</div>
					</p>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120 (2024)<span style="width:148mm;border-bottom-width:5mm"/>
						</div>
					...
					<!-- Page Header -->
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1120 (2024)<span style="width:148mm;"/>
						</div>
				...
				<!--  Schedule J, Line g  -->
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:99mm;">
								<span style="float:left;">Chapter 1 tax recapture from Form 4255
							<xsl:call-template name="SetFormLinkInline">
				...
				<!-- BEGIN SCHEDULE K -->
					<p>
						<div class="pageEnd" style="width:187mm;padding-top:1mm;">
							<div style="float:right;">
								<span style="width:80px;"/>Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2024)
							</div>
						</div>
					</p>
					<!-- END Page Break and Footer-->
...
reported on page 1, line 29a.)
					...
					<div  style="width:187mm;height:6mm;">
						<div class="styLNLeftNumBox" style="padding-left:4mm;">b</div>
						<div class="styLNDesc" style="width:167mm;">
							<span style="float:left;">The corporation's aggregate average annual gross receipts (determined under section 448(c)) for the 3 tax years preceding the current tax year are $30 million or more and the corporation has business interest expense.
							</span>		
						</div>
						<div class="styGenericDiv">
							<div class="styShadingCell" style="width:6mm;height:8mm;"/>
...
<span style="float:left;">adjustment, as described in the instructions, of $10 million or more?
					...
					<div class="pageEnd" style="width:187mm;">
						<div style="float:right;">
							<span style="width:80px;"/>
								Form 
							<span class="styBoldText" style="font-size:8pt;">1120</span> (2024)
					    </div>
					</div>
					</p>
					<!-- END Page Break and Footer-->
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;border-top:1 solid black;border-top-width1px;">
						...
						<div style="float:right;">
							<span style="width:80px;"/>  
                            Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2024)
                        </div>
					</div>
					<!-- END Page Break and Footer-->
					...
					<table class="styLeftOverTbl">
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
							Form 1120, Page 3, Schedule J, Line 1 - Section 1291 Indicator</xsl:with-param>
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">
							Form 1120, Page 3, Schedule J Line 1 - Section 197 Indicator</xsl:with-param>
						...
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Form 1120, Page 3, Schedule J,  Line 14 - Form 8816 Indicator</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/EstimatedTaxPaymentsAmt/@form8816Cd"/>
							<xsl:with-param name="DescWidth" select="300"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Form 1120, Page 3, Schedule J, Line 14 - Form 8816 Amount</xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/EstimatedTaxPaymentsAmt/@form8816Amt"/>
							<xsl:with-param name="DescWidth" select="300"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRow">
							<xsl:with-param name="Desc">Form 1120, Page 3, Schedule J, Line 14 - Section 847 Deduction Indicator
							</xsl:with-param>
