			...
			<body class="styBodyClass">
				<form id="Form1065ScheduleK2" style="width:256mm;">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;font-weight:bold;font-family:Arial;padding-top:2px;">
						...
						<span style="float:right;">Schedule K-3 (Form 8865) 2024</span>
					</div>
					<!-- Page 2 -->
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:152mm;height:17mm;">
						Portion of base erosion tax benefits reported on lines 6 through 16, on which tax is imposed by section 871 or 881, <br />
							with respect to which tax has been withheld under section 1441 or 1442 at reduced withholding rate pursuant to <br /> income tax treaty or subject to a reduced rate of tax under Regulations section 1.884-4(a)(2)(ii). Multiply the <br />amount of the base erosion tax benefit by a fraction equal to the rate of tax imposed under the treaty over the 30% (0.30) statutory rate. See instructions.
							<span class="sty1065K2DotLn">.........................</span>
						</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:17mm;">&nbsp;</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:17mm;">&nbsp;</div>
						<div class="styLNAmountBox" style="height:17mm;"><br />
							<xsl:call-template name="SetFormLinkInline">
