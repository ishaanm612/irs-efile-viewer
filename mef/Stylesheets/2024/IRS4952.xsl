...
<!-- Last Modified on XMLSpy by Ashleigh Smith on 08/20/2024 -->
				...
				<form name="IRS4952" style="font-family:arial;">
					...
					<div style="width:187mm;">
							...
							<div style="width:187mm;">
								<span style="float:left;font-size:8.5pt;">
									...
									<div class="styLNDesc" style="width:141mm;padding-left:3mm;">
										Investment interest expense paid or accrued in 2024 (see instructions)
							...
							<div style="width:187mm;">
								<span style="float:left;font-size:8.5pt;">
									...
									<div class="styLNDesc" style="width:141mm;height: mm;padding-left:3mm;">
										Disallowed investment interest expense from 2023 Form 4952, line 7
										<span class="styDotLn" style="float:right;">...........</span>
									</div>
								</span>
								<span style="float:right;font-size:8pt;">
							...
							<div style="width:187mm;">
								<span style="float:left;font-size:8.5pt;">
									...
									<div class="styLNDesc" style="width:141mm;height:7.5mm;padding-left:3mm;">
										Disallowed investment interest expense to be carried forward to 2025. Subtract line 6 from line 3.<br/>
						...
						<div style="width:187mm;padding-top:.3mm;font-size:7pt">
							...
							<div class="styGenericDiv" style="float:right;text-align:right">Form <span style="font-size:8pt;font-weight:bold;">4952</span> (2024)</div>
						</div>
					</div>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
