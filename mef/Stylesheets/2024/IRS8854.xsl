	...
	<xsl:template name="SetPageEndFooter">
		...
		<div class="pageEnd" style="width:187mm;padding-top:1mm;">
			...
			<div style="float:right;">
				...
				Form <span class="styBoldText" style="font-size:8pt;">8854</span> (2024)
			</div>
		</div>
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;float:none;clear:both;">
			<div style="float:left;">
				Form 8854 (2024)<span style="width:148mm;"/>
			</div>
			<div style="float:right;">
			...
			<body class="styBodyClass">
				<form name="IRS8854">
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;">
							Initial Expatriation Statement for Persons Who Expatriated in 2024
						</div>
					</div>
					<!-- END: Part II (Header)-->
					<!-- END Page Header -->
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" alt="ChangeAstLiab5YrBfrExptrtInd Yes" class="styCkbox">
								...
								<span>
									...
									<input type="checkbox" alt="ChangeAstLiab5YrBfrExptrtInd No" class="styCkbox">
          ...
          <!--div class="pageEnd" style="width:187mm;">
            ...
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8.5pt;">8854</span> (2024)
            </div>
          </div-->
						...
						<span style="float:right;font-size:6.5pt;">Form<b><span style="font-size:8pt;padding-right:1mm;padding-left:1mm;">8854</span></b>(2024)</span>	
					</div>
 		  <!--p style="page-break-before: always"/-->
					...
					<div style="width:187mm;float:none;clear:both;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;">
							Annual Expatriation Statement for Persons Who Expatriated Before 2024
						</div>
					</div>
					<!-- END: Part III (Header)-->
					<!-- BEGIN: Part III (Body) -->
					...
					<div class="styBB" style="width:187mm;float:none;display:block;">
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								column (d) for any property you disposed of in 2024 and see the instructions for Part III.
								<!--+++++++++++++++++++ Table Toggle Button +++++++++++++++++++-->
					...
					<div style="width:187mm;float:none;clear:both;" class="styBB">
						<div class="styPartName" style="width:15mm;">Part III</div>
						<div class="styPartDesc" style="padding-left:3mm;">
							Annual Expatriation Statement for Persons Who Expatriated Before 2024 (continued)
						</div>
					</div>
					<!-- END: Part III (Header)-->
						<!-- Begin (Line) 2 -->
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox">2</div>
							<div class="styIRS8854LNDesc" style="width:144mm">
								Did you receive any distributions of eligible deferred compensation items for 2024?
								<!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:18px"/>.
										<span style="width:11px"/>.
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox">3</div>
							<div class="styIRS8854LNDesc" style="width:144mm">
								Did you receive any distributions from a nongrantor trust for 2024?
								<!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:18px"/>.
										<span style="width:11px"/>.
