				...
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						...
						<div class="styTYBox" style="width:28mm;height:23mm;">
							...
							<div class="styTaxYear" style="width:100%;">20<span class="styTYColor" style="display:inline;">24</span>
							</div>
							<div style="width:100%;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							<span style="width:138.5mm;float:left;">
								Enter the number of days in 2024 you claim you can exclude for purposes of the substantial presence test:
							</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							Were you exempt as a teacher, trainee, or student for any part of 2 of the preceeding 6 calendar years (2018 through 2023)? 
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							During 2024, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status <br/>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8843</span> (2024)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							Enter the name of the charitable sports event(s) in the United States in which you competed during 2024 and the dates of <br/>
