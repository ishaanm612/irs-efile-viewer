...
<!-- Last Modified by Jermaine Merchant on 7/11/2024 -->
			...
			<body class="styBodyClass">
				<form name="IRS8889">
					...
					<div class="styBB" style="width:187mm;height:auto;">
						...
						<div class="styIRS8889LineItem" style="height:auto;">
							...
							<div class="styIRS8889LNDesc" style="height:auto;width:133mm;">
								Check the box to indicate your coverage under a high-deductible health plan (HDHP) during 2024.<br/>
								See instructions.
								<span style="width:3px;"/>
								<!--Dotted Line-->
						...
						<div class="styIRS8889LineItem" style="height:10.5mm;">
							...
							<div class="styIRS8889LNDesc" style="height:auto;width:137mm">
									HSA contributions you made for 2024 (or
									 those made on your behalf), including those made by the unextended due date of your tax return that were for 2024.
						...
						<div class="styIRS8889LineItem" style="height:10.5mm;">
							...
							<div class="styIRS8889LNDesc" style="height:auto;width:137mm">
									If you were under age 55 at the end of 2024 and, on the first day of 
									<span class="styBoldText">every</span> month during 2024, you<br/>
									 were, or were considered, an eligible individual with the <span class="styBoldText">same</span> coverage, 
									enter $4,150 ($8,300 for family<br/>coverage). <span class="styBoldText">All others,</span> see the instructions 
						...
						<div class="styIRS8889LineItem"  style="height:10.5mm;">
							...
							<div class="styIRS8889LNDesc" style="height:auto;width:137mm">
									Enter the amount you and your employer contributed to your Archer MSAs for 2024 from Form 8853,<br/>
									lines 1 and 2. If you or your spouse had family coverage under an HDHP at any time during 2024, also<br/>
						...
						<div class="styIRS8889LineItem"  style="height:7.5mm;">
							...
							<div class="styIRS8889LNDesc" style="height:auto;width:137mm">
									Enter the amount from line 5. But if you and your spouse each have separate HSAs and had family <br/>
									 coverage under an HDHP at any time during 2024, see the instructions for the amount to enter
									<span style="width:3px;"/>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:2mm;">..</span>
							</div>
						...
						<div class="styIRS8889LineItem"  style="height:7.5mm;">
							...
							<div class="styIRS8889LNDesc" style="height:auto;width:137mm">
									If you were age 55 or older at the end of 2024, married, and you or your spouse had family coverage<br/>
									 under an HDHP at any time during 2024, enter your additional contribution amount.	See instructions
									<span style="width:3px;"/>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:2mm;">.</span>
							</div>
						...
						<div class="styIRS8889LineItem" style="height:auto;">
							...
							HSA deduction. See the instructions.
					...
					<div>-->
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
							Form <span class="styBoldText" style="font-size:8pt;">8889</span> (2024)
						</div>
					</div>
					</div>
					<p  class="pageEnd" />
