				...
				<form name="Form8962">
					...
					<div class="styBB" style="width:187mm;">						
						...
						<div class="styTYBox" style="width:32mm;border-left:none;">
							...
							<div class="styTaxYear" style="line-height:30px;">20<span class="styTYColor" style="display:inline;">24</span></div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styLNRightNumBox" style="height:7mm;padding-top:3mm;border-bottom:0px solid black;">26</div>
						<div class="styLNAmountBox" style="height:7mm;padding-top:3mm;font-size:6pt;width:29mm;border-bottom:0px solid black;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;">
						...
						<div class="styLNRightNumBox" style="height:7mm;border-bottom:0px solid black;padding-top:3mm;">29</div>
						<div class="styLNAmountBox" style="font-size:6pt;height:7mm;width:29mm;border-bottom:0px solid black;padding-top:3.5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:1px solid black; padding-top:0.5mm;text-align:right;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:8pt;">8962</span> (2024)
						</div>						
					</div>
					<p style="page-break-before: always"/>
					<div class="styBB" style="width:187mm;">
						<span style="float:left;clear:none;">Form 8962 (2024)</span>
