			...
			<body class="styBodyClass">
				<form id="Form1065ScheduleK2" style="width:256mm;">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;font-weight:bold;font-family:Arial;">
						...
						<span style="float:right;">Schedule K-3 (Form 1065) 2024</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDivLS">
						Schedule K-3 (Form 1065) 2024
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								<tr style="border-top:1px solid black;">
									...
									<th class="styTableCellHeader" scope="col" style="font-weight:normal;">
										<strong>(a)</strong> Gross amount
									</th>
									<th class="styTableCellHeader" scope="col" style="font-weight:normal;">
										<strong>(b)</strong> Withholding tax rate
									</th>
									<th class="styTableCellHeader" scope="col" style="font-weight:normal;border-right:none;">
							...
							<tbody>
								<xsl:for-each select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp[1]">
									...
									<tr style="vertical-align:bottom;">
										...
										<td class="styTableCellAmtInherit" style="border-bottom:none;border-right:none;">
											<xsl:call-template name="PopulateAmount">
