			...
			<body class="styBodyClass" style="width:187mm;">
				...
				<div class="styStdDiv" style="border-top:1px solid black;">
					...
					<div class="styEINBox" style="width:77mm;text-align:left;font-size:7pt;font-weight:normal;word-break:break-all;">
						...
						<xsl:call-template name="PopulateText">
							<xsl:with-param name="TargetNode" select="$FormData/CitizenshipTypeCd"/>
						</xsl:call-template>
					</div>
				</div>
				<!-- Line 14 -->
				...
				<div class="styStdDiv">
					...
					<div class="sty709LongDesc">
						...
						<input type="checkbox" class="styCkboxNM" alt="Time To File Extension">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="styStdDiv" style="border-top:1px solid black;">
					...
					<div class="sty709LongDesc">
						...
						Did you and your spouse make gifts to third parties? See instructions. (If the answer is "Yes," complete Part III on page 2.)
						<span class="sty709DotLn">............................</span>
					</div>
					<div class="styLNRightNumBoxNBB" style="height:7.4mm;"><br />
						<xsl:call-template name="PopulateYesBox">
				...
				<div class="styStdDiv">
					<div class="styLNLeftNumBox">19</div>
					<div class="styLNDesc">
						If line 18 is less than line 17, enter <strong>balance due.</strong> See instructions
						<span class="sty709DotLn">.............</span>
					</div>
				...
				<div class="styStdDiv">
					<div class="styLNLeftNumBox">20</div>
					<div class="styLNDesc">
						If line 18 is greater than line 17, enter <strong>amount to be refunded</strong>
						<span class="sty709DotLn">.............</span>
					</div>
					<div class="styLNRightNumBoxNBB">20</div>
              ...
              <div style="width:164mm;float:left;clear:none;">
				...
				<div class="pageEnd" style="width:187mm;border-top:1px solid black;">
					...
					<span style="float:right;">
						Form <span class="styBoldText" style="font-size:8pt;">709</span> (2024)
					</span>
				</div>
				...
				<div class="styStdDiv" style="">
					...
					<div class="styLNRightNumBoxNBB" style="height:10.4mm;"><br /><br />
						<xsl:call-template name="PopulateYesBox">
				...
				<div class="styStdDiv" style="border-top:1px solid black;">
					...
					<div class="sty709LongDesc">
						...
						<input type="checkbox" class="styCkboxNM" style="" alt="Married this year">
							<xsl:call-template name="PopulateCheckbox">
						...
						married 
						<input type="checkbox" class="styCkboxNM" style="" alt="Divorced this year">
							<xsl:call-template name="PopulateCheckbox">
						...
						divorced or 
						<input type="checkbox" class="styCkboxNM" style="" alt="Widowed/deceased this year">
							<xsl:call-template name="PopulateCheckbox">
				...
				<div class="styStdDiv" style="border-top:1px solid black;">
					...
					<div class="sty709LongDesc">
						...
						Have you obtained required spousal consent for gifts made to third parties to be considered as made <br /> one-half by each spouse? 
						<span class="sty709DotLn">...............................</span>
					</div>
					<div class="styLNRightNumBoxNBB" style="height:7.4mm;">
						<xsl:call-template name="PopulateYesBox">
				...
				<div class="styStdDivLS" style="border-top:1px solid black;padding-top:1px;">
					...
					<div class="styGenericDiv" style="width:22mm;padding-top:1px;">
						<input type="checkbox" class="styCkboxNM" style="margin-right:2px;" alt="Valuation Discout Yes">
							<xsl:call-template name="PopulateYesCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/ValuationDiscountInd"/>
						...
						Yes
						<input type="checkbox" class="styCkboxNM" style="margin-right:2px;margin-left:3mm;" alt="Valuation Discout No">
							<xsl:call-template name="PopulateNoCheckbox">
								<xsl:with-param name="TargetNode" select="$FormData/ValuationDiscountInd"/>
								<xsl:with-param name="BackupName">F709/ValuationDiscountInd</xsl:with-param>
							</xsl:call-template>
						...
						<tbody>
								...
								<tr style="vertical-align:bottom;">
									...
									<td class="styTableCellCtrInherit">
										<input type="checkbox" class="styCkboxNM" style="" disabled="disabled">
											<xsl:attribute name="alt">Item <xsl:value-of select="ItemNum"/> Section 2632 b Election</xsl:attribute>
											<xsl:call-template name="PopulateCheckbox">
							...
							<xsl:for-each select="$FormData/SpouseGiftsSubjectToGiftTxGrp">
								<tr style="vertical-align:bottom;">
									...
									<td class="styTableCellCtrInherit" style="border-right-width:0px;">
										<input type="checkbox" class="styCkboxNM" style="">
											<xsl:attribute name="alt">Spouse Item <xsl:value-of select="ItemNum"/> Section 2652 a 3 Election</xsl:attribute>
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="Section2652a3ElectionInd"/>
						...
						<thead class="styTableThead">
							...
							<tr>
								...
								<th class="styTableCellHeader" style="width:11mm;font-weight:normal;border-right-width:0px;" scope="col">
									<strong>(j)</strong><br />2632(c) election out
								</th>
							</tr>
						</thead>
						<tbody>
								...
								<tr style="vertical-align:bottom;">
									...
									<td class="styTableCellCtrInherit">
										<input type="checkbox" class="styCkboxNM" style="" disabled="disabled">
											...
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="Section2632bElectionInd"/>
												<xsl:with-param name="BackupName">F709/P3/Section2632bElectionInd<xsl:number value="position()"/></xsl:with-param>
											</xsl:call-template>
										</input>
									</td>
									<td class="styTableCellCtrInherit">
								...
								<tr style="vertical-align:bottom;">
									...
									<td class="styTableCellCtrInherit">
										<input type="checkbox" class="styCkboxNM" style="" disabled="disabled">
											...
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="Section2632bElectionInd"/>
												<xsl:with-param name="BackupName">F709/P3/Spouse/Section2632bElectionInd<xsl:number value="position()"/></xsl:with-param>
											</xsl:call-template>
										</input>
									</td>
									<td class="styTableCellCtrInherit">
									...
									<td class="styTableCellCtrInherit" style="border-right-width:0px;">
										<input type="checkbox" class="styCkboxNM" style="">
											...
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="Section2632cElectionOutInd"/>
												<xsl:with-param name="BackupName">F709/P3/Spouse/Section2632cElectionOutInd<xsl:number value="position()"/></xsl:with-param>
											</xsl:call-template>
										</input>
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="Section2632cElectionOutInd"/>
				...
				<div class="styStdDiv">
					...
					<div class="styLNDesc" style="width:98mm;height:auto;">
						Charitable deduction. Enter the total value of items on Parts 1 and 3 of Schedule A for which the box in column (k) is checked
						<span class="sty709DotLn">.......</span>
					</div>
					<div class="styLNRightNumBox" style="height:7.4mm;"><br />7</div>
...
or D, if applicable). Complete Schedule A before beginning Schedule B. See instructions for recalculation of the column (c) amounts. Attach calculations.
				...
				<div class="styTableContainerLandscapeNBB" id="schCtable1" style="border-top:1px solid black;">
					<xsl:call-template name="SetInitialState"/>
					<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
						<thead class="styTableThead">
							<tr style="vertical-align:top;">
								<th class="styTableCellHeader" rowspan="2" style="width:94mm;font-weight:normal;" scope="col" >
									<strong>(a)</strong><br />Name of deceased spouse <br /> (dates of death after December 31, 2010, only)
								</th>
								<th class="styTableCellHeader" rowspan="2" style="width:24mm;font-weight:normal;" scope="col" >
									<strong>(b)</strong><br />Date of death
								</th>
								<th class="styTableCellHeader" colspan="2" style="width:30mm;font-weight:normal;" scope="colgroup" >
								...
								<th class="styTableCellHeader" rowspan="2" style="width:36mm;font-weight:normal;border-right-width:0px;" scope="col" >
									<strong>(f)</strong><br />Date of gift(s) (enter as <br /> mm/dd/yy for Part 1 and <br /> as yyyy for Part 2)
								</th>
							</tr>
							<tr>
						...
						<tbody>
							<tr>
								<th class="styTableCellTextInherit" colspan="7" style="border-right-width:0px;color:white;background-color:black;">
				...
				<div class="styStdIBDivLS">
					<div class="styLNDesc" style="width:65.9mm;height:auto;padding-top:1.5mm;">
					...
					<div class="styLNAmountBoxNBB" style="width:37.9mm;height:8mm;padding-right:0.5mm;border-right-width:1px;"><br />
						<xsl:call-template name="PopulateAmount">
							<xsl:with-param name="TargetNode" select="$FormData/TotalGSTExemptionClaimedAmt"/>
						</xsl:call-template>
					</div>
					<div class="styLNDesc" style="width:114mm;height:auto;padding-top:1.5mm;padding-left:1.5mm;">
	...
	<xsl:template name="FillTable13Col">
		...
		<tr style="font-size:7pt;vertical-align:bottom;">
			...
			<td class="styTableCellCtrInherit">
				<input type="checkbox" class="styCkboxNM" style="" disabled="disabled">
					<xsl:attribute name="alt">Item <xsl:value-of select="$LineNumber"/> Section 2632 b Election</xsl:attribute>
					<xsl:call-template name="PopulateCheckbox">
						<xsl:with-param name="TargetNode" select="/.."/>
	...
	<xsl:template name="FillPage5Table">
		...
		<tr style="font-size:7pt;vertical-align:bottom;">
			...
			<td class="styTableCellCtrInherit" style="border-right-width:0px;">
				<input type="checkbox" class="styCkboxNM" style="">
					<xsl:attribute name="alt">Item <xsl:value-of select="$LineNumber"/> Section 2632 c Election Out</xsl:attribute>
					<xsl:call-template name="PopulateCheckbox">
						<xsl:with-param name="TargetNode" select="/.."/>
