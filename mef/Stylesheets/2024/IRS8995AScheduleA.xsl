			...
			<body class="styBodyClass">
				<form id="Form8995AScheduleA">
					...
					<div class="sty8995ASALineDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;">
						...
						income is more than $191,950 but not $241,950 ($383,900 and $483,900 if married filing jointly). If your taxable income isn’t more than $191,950
						($383,900 if married filing jointly) and you’re not a patron of an agricultural or horticultural cooperative, don’t file this form; instead, file Form 8995, 
						...
						If your taxable income is more than $241,950 ($483,900 if married filing jointly), your specified service trade or business doesn’t qualify for the deduction.
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;">Schedule A (Form 8995-A) 2024</span>
					</div>
