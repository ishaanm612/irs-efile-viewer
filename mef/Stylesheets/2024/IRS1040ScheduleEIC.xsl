...
<!-- 06/23/2024 - Changes for UWR 982125 - AJH -->
...
<div class="styLNDesc" style="width:149mm;height:23mm;">
        ...
        <span style="width:149mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/>
          ...
          Otherwise, at the time we process your return, we may reduce your EIC. If the name or SSN on the child's social security card is not correct, call the Social Security Administration at 800-772-1213.
         </span> 
        <span style="width:149mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/>
...
<!--Line 2-->
        <tr>
            ...
            <td scope="row" style="width:75mm;border-bottom:1px solid black;padding-top:1mm:padding-left:0mm;">
				...
				<span style="font-weight:normal;"> The child must have an SSN as defined in the 
					...
					born and died in 2024 or you are claiming the self-only EIC (see instructions). 
					If your child was born and died in 2024 and did not have an SSN, enter 
            ...
            <xsl:if test="count($Form1040ScheduleEICData/QualifyingChildInformation/ChildBirthYr) &lt;1">   
				<td style="width:34mm;border-left:1px solid black;border-bottom:3px solid black;padding-top:1mm;text-align:left;padding-left:1mm;">      
					...
					<div style="font-size: 6pt;padding-top:1.0mm;padding-bottom:1mm;text-align:left;color:black;">
						<i>If born after 2005 <b>and</b> the child is younger than you (or your spouse, if filing jointly), skip lines 4a and 4b; go to line 5.</i>      
					</div>	                             
				</td>   
				<td style="width:34mm;border-left:1px solid black;border-bottom:3px solid black;padding-top:1mm;text-align:left;padding-left:1mm;">  		  
					Year  <span style="width:2mm;">              
		...
		<tr>
            ...
            <td style="height:4.0mm;width:75mm;border-bottom:1px solid black;vertical-align:top;padding-top:1mm;">
				<span style="font-size:7pt;">Was the child under age 24 at the end of <br/>2024, a student, and younger than you (or your spouse, if filing jointly)? </span>           
            </td>	
...
<xsl:with-param name="TargetNode" select="$Form1040ScheduleEICData/QualifyingChildInformation[1]/ChildIsAStudentUnder24Ind"/>
        ...
        <tr>
            ...
            <td style="height:4.0mm;width:75mm;vertical-align:top;padding-top:1mm;border-bottom:3px solid black;">
				Was the child permanently and totally disabled during any part of 2024? 
            </td>    
  ...
  <tr>
    <td style="vertical-align:top;width:4mm;padding-top:1mm;padding-left:1.5mm;"><b>6</b></td>
       <td style="width:75mm;border-bottom-width:0px;padding-top:1mm">
             ...
             <span style="font-size:9pt;"><b>you in the United States during 2024</b></span><br/><br/>
             <span style="width:65mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/> If the child lived with you for more than half of<br/>
				2024 but less than 7 months, enter "7".</span>         
			 <span style="width:65mm;padding-top:2mm;"><img src="{$ImagePath}/1040_EIC_Bullet_Round.gif" alt="Round Bullet"/> If the child was born or died in 2024 and your<br/>
			home was the child's home for more than half the<br/>
			time they were alive during 2024, enter "12."<br/></span> 
   </td> 
   ...
   <div class="styFixedUnderline" style="width:187mm;padding-top:0mm;height:0.5mm;border-bottom-width:0px;border-top-width:1px;">  
    <!-- Footer-->   
      ...
      <div style="float:right;">
        ...
        <span class="styBoldText">Schedule EIC (Form 1040) 2024 </span>
      </div>    
          </div>   
    <br/> <br/>
