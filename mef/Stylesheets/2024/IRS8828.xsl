			...
			<body class="styBodyClass">
				<form name="IRS8828">
                  ...
                  <b>Do not</b><br/>complete this form.
						...
						<!-- (3) ////////////////////////////////////////////////////-->
						<div class="styIRS8828LineItem" style="height:13.6mm; width:187mm">
					...
					<div class="styBB" style="width:187mm;">
						...
						<!-- (12) ////////////////////////////////////////////////////-->
						<div class="styIRS8828LineItem" style="height:8mm">
							<div class="styIRS8828LNLeftNumBox" style="padding-left:0px; padding-right:5px;padding-top:10px;">12</div>
							<div class="styIRS8828LNDesc" style="width:144mm;padding:10px 0px 0px 0px;">
								<div class="styIRS8828LNDesc" style="width:105mm;">
									Adjusted basis of your interest in the home sold or disposed of (see instructions)
								</div>
								<div class="styIRS8828LNDesc" style="width:39mm;text-align:right;float:right;padding:0px 0px 0px 2px;">
									<!--Dotted Line-->
									<span class="styDotLn">..........</span>
								</div>
							</div>
							<xsl:call-template name="CreateBox">
								...
								<xsl:with-param name="NumberBoxStyle">padding-top:13px</xsl:with-param>
								<xsl:with-param name="AmountBoxStyle">padding-top:13px</xsl:with-param>
							</xsl:call-template>
						</div>
						<!-- (13) ////////////////////////////////////////////////////-->
						<div class="styIRS8828LineItem" style="height:8mm">
              ...
              <xsl:call-template name="CreateBox">
						...
						<!-- (14) ////////////////////////////////////////////////////-->
						<div class="styIRS8828LineItem" style="height:8mm">
							<div class="styIRS8828LNLeftNumBox" style="padding-left:0px; padding-right:5px;padding-top:10px">14</div>
							<div class="styIRS8828LNDesc" style="width:144mm;padding:10px 0px 0px 0px;">
						...
						<!-- (16) ////////////////////////////////////////////////////-->
						<div class="styIRS8828LineItem" style="height:8mm">
							<div class="styIRS8828LNLeftNumBox" style="padding-left:0px; padding-right:5px;padding-top:17px;">16</div>
							<div class="styIRS8828LNDesc" style="width:144mm;padding:16px 0px 0px 0px;">
								<div class="styIRS8828LNDesc" style="width:60mm;">
									Adjusted qualifying income (see instructions)
								</div>
								<div class="styIRS8828LNDesc" style="width:84mm;text-align:right;float:right;padding:0px 3mm 0px 8px;">
									<!--Dotted Line-->
									<span class="styDotLn">....................</span>
								</div>
							</div>
							<xsl:call-template name="CreateBox">
								...
								<xsl:with-param name="Height">inherit</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">padding-top:16px</xsl:with-param>
								<xsl:with-param name="AmountBoxStyle">padding-top:16px</xsl:with-param>
							</xsl:call-template>
						</div>
						<!-- (17) ////////////////////////////////////////////////////-->
						<div class="styIRS8828LineItem" style="height:11mm;">
							<div class="styIRS8828LNLeftNumBox" style="padding-left:0px; padding-right:5px;padding-top:13px;">17</div>
							<div class="styIRS8828LNDesc" style="height:inherit;width:144mm;padding-top:13px;">
                ...
                <xsl:call-template name="CreateBox">
                  ...
                  <xsl:with-param name="Height">inherit</xsl:with-param>
                  <xsl:with-param name="NumberBoxStyle">padding-top:24px;</xsl:with-param>
                  <xsl:with-param name="AmountBoxStyle">padding-top:24px;</xsl:with-param>
                </xsl:call-template>
							</div>
						</div>
						<!-- (18) ////////////////////////////////////////////////////-->
